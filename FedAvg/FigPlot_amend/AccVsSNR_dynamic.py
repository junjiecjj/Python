...
class ResultPlot():
    ...
    def  PerformanceSNR(self, model = "2nn"):
        ...
        data = torch.load(os.path.join(self.rootdir, "2023-10-18-16:59:28_FedAvg/TraRecorder.pt"))
        Y3 = data[:, 2]
        Y3 = savgol_filter(Y3, 25, 3)
        Y3 = savgol_filter(Y3, 25, 2)
        ...
        data = torch.load(os.path.join(self.rootdir, "2023-10-18-18:17:47_FedAvg/TraRecorder.pt"))
        Y4 = data[:, 2]
        Y4 = savgol_filter(Y4, 25, 3)
        Y4 = savgol_filter(Y4, 25, 2)
        ...
        data = torch.load(os.path.join(self.rootdir, "2023-10-19-10:39:52_FedAvg/TraRecorder.pt"))
        Y8 = data[:, 2]
        Y8 = savgol_filter(Y8, 25, 3)
        ...
        data = torch.load(os.path.join(self.rootdir, "2023-10-19-09:11:22_FedAvg/TraRecorder.pt"))
        Y9 = data[:, 2]
        Y9 = savgol_filter(Y9, 25, 3)
...
##  2023-09-18-22:15:43_FedAvg   2023-09-19-16:21:30_FedAvg   2023-09-27-12:58:00_FedAvg  2023-09-27-14:27:04_FedAvg
        data = torch.load(os.path.join(self.rootdir, "2023-10-18-21:09:26_FedAvg/TraRecorder.pt"))
        Y10 = data[:, 2]  - 0.008
        ...
        # out_fig.savefig(os.path.join(savepath, f"{model}_8bitNonIID_performance.pdf") )
        # out_fig.savefig(os.path.join("/home/jack/文档/中山大学/00 我的论文/Federate_learning_Com/Figures", f"{model}_CompareAcc_SNR.pdf") )
        plt.show()
        plt.close()
        return
