...
class ResultPlot1bit():
    ...
    def Onebit_G8(self, model = '2nn', ):
        ...
        # ##================ 1 bit,  0 error =============================
        # lb = "1-bit, lr=0.002, G=8, "+ r"$\epsilon = 0$"
        # data = torch.load(os.path.join(self.rootdir, "2023-10-19-12:02:32_FedAvg/TraRecorder.pt"))
        # Y = data[:, 2]
        # # Y = savgol_filter(Y, 25, 10)
        # Y = savgol_filter(Y, 25, 3)
        # # Y = savgol_filter(Y, 25, 3)
        ...
        ##================ 1 bit,  0 error =============================
        lb = "1-bit, lr=0.003, G=8, "+ r"$\epsilon = 0$"
        ...
        ##================ 1 bit,  0.01 error =============================
        lb = "1-bit, lr=0.003, G=8, "+ r"$\epsilon = 0.01$"
        data = torch.load(os.path.join(self.rootdir, "2023-10-19-14:54:08_FedAvg/TraRecorder.pt"))
        Y = data[:, 2]
        # Y = savgol_filter(Y, 25, 10)
        Y = savgol_filter(Y, 25, 3)
        # Y = savgol_filter(Y, 25, 3)
        ...
        ##================ 1 bit,  0.1 error =============================
        lb = "1-bit, lr=0.003, G=8, "+ r"$\epsilon = 0.1$"
        data = torch.load(os.path.join(self.rootdir, "2023-10-19-16:18:25_FedAvg/TraRecorder.pt"))
        Y = data[:, 2]
        # Y = savgol_filter(Y, 25, 10)
        Y = savgol_filter(Y, 25, 3)
        # Y = savgol_filter(Y, 25, 3)
        ...
        ##================ 1 bit,  0.2 error =============================
        lb = "1-bit, lr=0.003, G=8, "+ r"$\epsilon = 0.2$"
        data = torch.load(os.path.join(self.rootdir, "2023-10-19-17:43:28_FedAvg/TraRecorder.pt"))
        Y = data[:, 2]
        # Y = savgol_filter(Y, 25, 10)
        Y = savgol_filter(Y, 25, 3)
        # Y = savgol_filter(Y, 25, 3)
        ...
        # i += 1
        # ##================ 1 bit,  0.5 error =============================
        # lb = "1-bit, lr=0.002, G=8, "+ r"$\epsilon = 0.5$"
