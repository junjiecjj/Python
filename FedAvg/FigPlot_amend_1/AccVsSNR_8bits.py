...
class ResultPlot():
    ...
    def PerformanceSNR_with8bit(self, model = '2nn', ):  ## E = 10, B = 50
...
##  2023-09-28-22:04:07_FedAvg
        ...
        legend1 = axs.legend(loc='lower left', bbox_to_anchor = (0.58, 0.2, 0.2, 0.5),  borderaxespad = 0, edgecolor = 'black', prop = font1, facecolor = 'none',labelspacing = 0.2) ## loc = 'lower left',
        ...
        out_fig.savefig(os.path.join(savepath, f"{model}_8bitAcc_SNR.eps") )
        # out_fig.savefig(os.path.join(savepath, f"{model}_8bitNonIID_performance.pdf") )
        # out_fig.savefig(os.path.join("/home/jack/文档/中山大学/00 我的论文/Federate_learning_Com/Figures", f"{model}_8bitAcc_SNR.pdf") )
        plt.show()
        plt.close()
        return
...
pl.PerformanceSNR_with8bit(model = model)
