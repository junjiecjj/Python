...
class ResultPlot1bit():
    ...
    def compare_1bit_SR_7(self, model = '2nn', ):
        ...
        ##  2023-10-09-17:24:57_FedAvg   2023-10-10-10:45:35_FedAvg
        data = torch.load(os.path.join(self.rootdir, "2023-10-10-10:45:35_FedAvg/TraRecorder.pt"))
        Y4 = data[:, 2]
        ...
        ## 2023-09-19-17:49:14_FedAvg   2023-09-19-13:46:10_FedAvg
        ...
        out_fig.savefig(os.path.join(savepath, f"{model}_1BitDQ_NonIID_performance_SR7.eps"))
