...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 14 10:32:00 2025
    ...
    for jj, snrsen in enumerate(SNRsen):
        ...
        for kk, It in enumerate(range(Iter)):
            ...
            for it in range(max_iterations):
                ...
                # 定义优化变量
                Rx = cpy.Variable((Nt, Nt), symmetric = True) # hermitian, symmetric
                D = cpy.Variable((Nt, Nt), symmetric = True)

                ### cpy.tr_inv save me.
                objective = Ms * cpy.tr_inv(Rx/sigma_s2 + Sigma_s_inv) + cpy.trace(D)
