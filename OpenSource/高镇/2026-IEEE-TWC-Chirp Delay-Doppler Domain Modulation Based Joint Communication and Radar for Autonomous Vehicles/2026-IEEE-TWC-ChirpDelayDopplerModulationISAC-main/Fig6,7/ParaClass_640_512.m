...
methods
function obj = ParaClass_640_512()
    %PARACLASS 构造此类的实例
    %   此处显示详细说明
    %% Basic
    obj.fc          = 80e9;% 80e9
    ...
    obj.N_f         = round(obj.TcEff / obj.Ts);
    obj.N_c         = 128;
    ...
    % obj.velocity = [0;2;8];% relative velocity is positive if relative direction of motion is forward
    obj.CarCenter = [0 0 1;...
                     0 30 1;...
...
% randVel = 6+randi(obj.N_c/obj.Nt.tot-12);
% randVel = 6+floor((rand(1)*(obj.N_c/obj.Nt.tot-12))./obj.velocity_resolution)*obj.velocity_resolution;
