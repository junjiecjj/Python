...
%                       IM_rng_bit      8 × Para.N_frame, N_s=500, wherein
%                                       256 is used for IM
...
DataEstAll = struct( ...
    ...
    'IM_rng_bit', zeros(1, 8*Para.N_frame),...
