function [H_amp, lambda,powerNoise] = AMP_NNSPL(Y, Phi, damp, niter, tol, sel_NN_set)
...
% clear index_ahead
% clear index_latter
index_3D = 1/(1+1+P); %left+right+freq
