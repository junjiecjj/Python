...
import sys
sys.path.append('..')
from DigiCommPy.signalgen import sine_wave
...
def compare_convolutions():
    ...
    from DigiCommPy.essentials import my_convolve #import our function from essentials.py
...
def analytic_signal_demo():
    ...
    import numpy as np
    import matplotlib.pyplot as plt
    from DigiCommPy.essentials import analytic_signal #import our function from essentials.py
