...
axs.annotate("Shannon limit\n-1.59dB", xy = (0.155, 0.2) , xytext = (0.06,0.01) , size = 20, xycoords = 'figure fraction', textcoords='figure fraction', arrowprops=dict(color='r',arrowstyle='<|-',connectionstyle='arc3'))
# axs.legend()
plt.show()
plt.close()
...
axs.text(18, 6.5, "AWGN channel capacity", color='k', size = 20, rotation = 44., ha = "center", va="center",)
axs.text(20, 5.4, "Fading channel Ergodic capacity", color='k', size = 20, rotation = 43., ha = "center", va="center",)
