...
def prox_grad(y, A, x, t, L):
    ...
    See Section 5.3.3 of "Statistical Learning with Sparsity" by Hastie, Tibshirani and Wainwright for more details.
    Inputs
...
def nesterov(y, A, x, t, L, it, theta):
    ...
    See Section 5.3.4 of "Statistical Learning with Sparsity" by Hastie, Tibshirani and Wainwright for more details.
    Inputs
        y: measurement vector
        A: sensing matrix
        x: signal estimate
