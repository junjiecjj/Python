...
FFTN = 2048        ## 执行FFT的点数，可以比N_sample大很多，越大频谱越精细
...
tmp = scipy.fftpack.fftshift(scipy.fftpack.fft(x_sample, n = FFTN))
Xf_recov = ffilter * tmp
...
#%% plus
#======================================= 0,1 =========================================
axs[0,1].stem(t, plus, linefmt='r--', markerfmt='gD', basefmt='b--', bottom=0)
# plot(t, plus, color='b', marker='o', ls = 'none', label='Plus',)
...
axs[0,2].plot(t[::4], x_sample[::4], color='b', marker = 'o', ms = 2, ls = 'none',  label='x_sampled',)
...
axs[0,4].plot(t, xf_recov[:x.size], color='b', linestyle='-',  label='x_recov',)
...
#%%======================================= 1,4 =========================================
axs[1,4].plot(f, Afrecov, color='r', linestyle='-', label='幅度',)
