...
#  方法一，二：将 X 重新排列, 把负频率部分搬移到序列的左边, 把正频率部分搬移到序列的右边
HY1 = scipy.fftpack.fftshift(H1,)      # 新的频域序列 Y
#Y1=X1
...
axs[0,1].set_title('x半谱', fontproperties=font3)
...
axs[1,0].plot(t, s, color='b', linestyle='-', label='恢复的信号值',)
...
#======================================= 1,1 =========================================
axs[1,1].plot(f_s, AS, color='r', linestyle='-', label='幅度',)
...
axs[1,1].set_title('s半谱', fontproperties=font3)
...
#%% h
#======================================= 2,0 =========================================
axs[2,0].plot(t, s, color='b', linestyle='-', label='恢复的信号值',)
...
#======================================= 2,1 =========================================
axs[2,1].plot(f_h, AH, color='r', linestyle='-', label='幅度',)
...
#======================================= 2,4 =========================================
axs[2,4].plot(f_h, PhaH1, color='#FF8C00', linestyle='-', label='虚部',)
