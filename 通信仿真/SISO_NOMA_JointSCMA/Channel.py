...
def Large_mac(K, frame_len, BS_locate, users_locate, beta_Au, PL_Au, sigma2 = 1):
    hdLos = np.ones((K,))
...
def Large_scma(K, J, frame_len, BS_locate, users_locate, beta_Au, PL_Au, sigma2 = 1):
    hdLos = np.ones((K, J))
...
def PassChannelSCMA(Tx_sig, noise_var = 1, ):
