...
axs[2].plot(t, x, color = 'b', lw = 1, label = '幅度调制AM信号')
...
axs[2].set_ylabel('幅度',)
axs[2].set_title("幅度调制AM信号")
axs[2].legend()

axs[3].plot(t, inst_amplitude, color = 'r', lw = 2, label = '解调信号')
axs[3].plot(t, at, color = 'b', lw = 2, ls='--', label = '原始波形')
...
axs[2].plot(t, s, color = 'b', lw = 0.2, label = '幅度调制AM信号')
axs[2].set_xlabel('时间 (s)',)
axs[2].set_ylabel('幅度',)
axs[2].set_title("幅度调制AM信号")
axs[2].legend()

axs[3].plot(t, s_demod, color = 'r', label = '解调信号 (时域)')
axs[3].plot(t, m, color = 'b', lw = 2, ls='--', label = '原始波形 (时域)')
axs[3].set_xlabel('时间 (s)',)
axs[3].set_ylabel('幅度',)
...
axs[2].plot(t, x, color = 'b', lw = 0.2, label = '频率调制FM信号')
axs[2].set_xlabel('时间 (s)',)
axs[2].set_ylabel('幅度',)
axs[2].set_title("频率调制FM信号")
axs[2].legend()

axs[3].plot(t_demod, mt_hat, color = 'r', label = '解调信号 (时域)')
axs[3].plot(t, mt, color = 'b', lw = 2, ls='--',  label = '原始波形 (时域)')
axs[3].set_xlabel('时间 (s)',)
axs[3].set_ylabel('幅度',)
axs[3].set_title("解调信号 (时域)")
...
axs[3].plot(t, mt_hat, color = 'r', label = '解调信号 (时域)')
axs[3].plot(t, mt, color = 'b', lw = 2, ls='--',  label = '原始波形 (时域)')
axs[3].set_xlabel('时间 (s)',)
axs[3].set_ylabel('幅度',)
axs[3].set_title("解调信号 (时域)")
