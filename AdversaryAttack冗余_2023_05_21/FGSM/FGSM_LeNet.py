...
Utility.plotXY(epsilons, accuracies, xlabel = r"$\mathrm{\epsilon}$", ylabel = "Accuracy", title = "Accuracy vs Epsilon", legend = "Y vs. X", figsize = (5, 5), savepath = "/home/jack/snap/", savename = "hh2")
Utility.FGSM_draw_image(len(epsilons), len(examples[0]), epsilons, examples,  savepath = "/home/jack/snap/", savename = "FGSM_samples2")
