...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec  6 02:06:57 2025
...
#     def addlog(self):
#         #  losslog.shape = [1,len(loss)],[2,len(loss)],[2,len(loss)]...,[epoch,len(loss)]
#         self.losslog = torch.cat((self.losslog, torch.zeros(1) ))
#         self.samples = 0
#         return
...
#         loss_val = self.los_fn(sr, hr)
#         self.losslog[-1] += loss_val.item()
#         return loss_val
