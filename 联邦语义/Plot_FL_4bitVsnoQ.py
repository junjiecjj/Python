...
def psnrVSround( ):
    ...
    Y3 = data[:, 4]
    Y3 = savgol_filter(Y3, 25, 6)
    axs.plot(data[:, 0], Y3, label = lb, color = 'b', linestyle = ':', linewidth = lw, marker = 'd', mfc='white', mew = 2, ms = 15, markevery=100)
...
def PSNRvsTestSNR( ):
    ...
    Y3 = data[:, 2]
    # Y2 = savgol_filter(Y2, 25, 6)
    axs.plot(data[:, 0], Y3, label = lb, color = 'b', linestyle = ':', linewidth = lw, marker = 'd', mfc='white', mew = 2, ms = 15, markevery=4)
