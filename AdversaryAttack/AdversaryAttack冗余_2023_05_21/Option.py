...
# Data specifications
# 数据根目录
parser.add_argument('--dir_fashionminst', type = str, default = home+'/SemanticNoise_AdversarialAttack/Data/FashionMinst', help = 'dataset directory')  # cjj
parser.add_argument('--dir_minst', type = str, default = home+'/SemanticNoise_AdversarialAttack/Data/Mnist', help = 'dataset directory')  # cjj
...
# 预训练模型地址
parser.add_argument('--pretrain', type = str, default = home+'/SemanticNoise_AdversarialAttack/IPT_pretrain.pt')  # cjj
parser.add_argument('--save', type = str, default = home+'/SemanticNoise_AdversarialAttack/results/',  help = 'file name to save')  #cjj

parser.add_argument('--saveModel', type = str, default = home + '/SemanticNoise_AdversarialAttack/ResultModels',  help = 'file name to save')  #cjj
