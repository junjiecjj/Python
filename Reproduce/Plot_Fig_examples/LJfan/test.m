...
pos3 = [0.08 0.12 0.40 0.32];
pos4 = [0.55 0.12 0.40 0.32];

ax1 = axes('Position', pos1, 'Color', 'w', 'FontName', 'Times New Roman', 'FontSize', fontSizeAxis);
...
ax2 = axes('Position', pos2, 'Color', 'w', 'FontName', 'Times New Roman', 'FontSize', fontSizeAxis);
...
ax3 = axes('Position', pos3, 'Color', 'w', 'FontName', 'Times New Roman', 'FontSize', fontSizeAxis);
...
ax4 = axes('Position', pos4, 'Color', 'w', 'FontName', 'Times New Roman', 'FontSize', fontSizeAxis);
...
exportgraphics(gcf, 'Fig5.eps', 'ContentType', 'vector');
