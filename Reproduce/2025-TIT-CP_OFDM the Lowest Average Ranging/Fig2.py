#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fig. 2 reproduction: 16-QAM With CP, P-ACF."""
...
axs.plot(x, 10*np.log10(TheoAvePACF_SC), color='#F65314', linestyle='--', linewidth=2, label='CP-SC')
# axs.plot(x, 10*np.log10(Sim_PACF_SC_avg), color='#F65314', linestyle='none', marker='x', ms=8, markevery=4, label='CP-SC, Simulation')
axs.plot(x, 10*np.log10(TheoAvePACF_CDMA), color='#00A1F1', linestyle='--', linewidth=2, label='CP-CDMA')
# axs.plot(x, 10*np.log10(Sim_PACF_CDMA_avg), color='#00A1F1', linestyle='none', marker='1', ms=10, markevery=4, label='CP-CDMA, Simulation')
axs.plot(x, 10*np.log10(TheoAvePACF_OTFS), color='#05C349', linestyle='-.', linewidth=2, label='CP-OTFS')
...
axs.plot(x, 10*np.log10(TheoAvePACF_AFDM), color='#000000', linestyle=':', linewidth=2, label='CP-AFDM')
# axs.plot(x, 10*np.log10(Sim_PACF_AFDM_avg), color='#000000', linestyle='none', marker='s', ms=6, markevery=4, markerfacecolor='none', label='CP-AFDM, Simulation')
axs.plot(x, 10*np.log10(TheoAvePACF_OFDM), color='#8A2BE2', linestyle='-', linewidth=2, label='CP-OFDM')
...
axs.set_yticks(np.arange(-30, 1, 5))


plt.savefig("Fig2_TIT.pdf")
plt.show()
plt.close()
