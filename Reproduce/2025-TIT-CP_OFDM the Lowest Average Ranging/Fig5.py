...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 30 16:48:48 2026

@author: jack
"""

"""Fig. 5 reproduction: 16-PSK Without CP, A-ACF."""
...
axs.plot(x, 10*np.log10(TheoAveAACF_SC), color='#F65314', linestyle='--', linewidth=2, label='SC, Theoretical')
# axs.plot(x, 10*np.log10(Sim_AACF_SC_avg), color='#F65314', linestyle='none', marker='x', ms=8, markevery=8, label='SC, Simulation')
axs.plot(x, 10*np.log10(TheoAveAACF_CDMA), color='#00A1F1', linestyle='--', linewidth=2, label='CDMA, Theoretical')
# axs.plot(x, 10*np.log10(Sim_AACF_CDMA_avg), color='#00A1F1', linestyle='none', marker='1', ms=10, markevery=8, label='CDMA, Simulation')
axs.plot(x, 10*np.log10(TheoAveAACF_OTFS), color='#05C349', linestyle='-.', linewidth=2, label='OTFS, Theoretical')
...
axs.plot(x, 10*np.log10(TheoAveAACF_AFDM), color='#000000', linestyle=':', linewidth=2, label='AFDM, Theoretical')
# axs.plot(x, 10*np.log10(Sim_AACF_AFDM_avg), color='#000000', linestyle='none', marker='s', ms=6, markevery=8, markerfacecolor='none', label='AFDM, Simulation')
axs.plot(x, 10*np.log10(TheoAveAACF_OFDM), color='#8A2BE2', linestyle='-', linewidth=2, label='OFDM, Theoretical')
...
axs.set_title(r'16-PSK Without CP')
...
# plt.savefig("Fig5_TIT_Without_CP.pdf", )
plt.show()
plt.close()
