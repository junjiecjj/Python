...
for idx = 1:length(SNR_dB_vec)
    ...
    Rs_coherent = Rs_fun(beta_coherent);
...
figure(2);
semilogy(SNR_dB_vec, CRB_orth_deg, 'k-', 'LineWidth', 1.8);
hold on;
semilogy(SNR_dB_vec, CRB_orth_63_deg, 'ro', 'MarkerSize', 7, 'LineWidth', 1.3);
...
figure(3);
semilogy(SNR_dB_vec, CRB_coherent_deg, 'k-', 'LineWidth', 1.8);
hold on;
semilogy(SNR_dB_vec, CRB_coherent_63_deg, 'ro', 'MarkerSize', 7, 'LineWidth', 1.3);
