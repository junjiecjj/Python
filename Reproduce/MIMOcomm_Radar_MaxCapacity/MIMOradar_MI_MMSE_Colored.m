...
lambda_Z_s = lambda_Z(end-N+1:end);
U_Z_s = U_Z(:, end-N+1:end);
...
fprintf('\nEigenvalues of Sigma_H, descending:\n');
disp(lambda_H.');

fprintf('Selected eigenvalues of Sigma_Z, ascending:\n');
disp(lambda_Z_s.');
