...
p1 = semilogy(SNR_dB_vec+10, RMSE_orth_deg, 'r--', 'LineWidth', 1.3, 'MarkerSize', 7); hold on;
p1.Color = '#00A1F1';
p2 = semilogy(SNR_dB_vec+10, CRB_orth_A_deg, 'r-', 'LineWidth', 1.8);
p2.Color = '#00A1F1';
p3 = semilogy(SNR_dB_vec+10, CRB_orth_a_deg, 'rd', 'LineWidth', 1.3, 'MarkerSize', 7);
p3.Color = '#00A1F1';

p4 = semilogy(SNR_dB_vec+10, RMSE_coherent_deg, 'b--', 'LineWidth', 1.3, 'MarkerSize', 7);
p4.Color = '#FF8853';
p5 = semilogy(SNR_dB_vec+10, CRB_coherent_A_deg, 'b-', 'LineWidth', 1.8);  
p5.Color = '#FF8853';
p6 = semilogy(SNR_dB_vec+10, CRB_coherent_a_deg, 'bd', 'LineWidth', 1.3, 'MarkerSize', 7);
p6.Color = '#FF8853';
...
h_legend = legend('ML, orthogonal', ...
            'CRB Eq.(14), orthogonal', ...
            'CRB Eq.(15), orthogonal', ...
            'ML, coherent', ...
            'CRB Eq.(14), coherent', ...
            'CRB Eq.(15), coherent', ...
            'Location', 'northeast', ...
...
set(get(gca, 'XAxis'), 'FontSize', 14);  % 调整坐标轴刻度标签（tick labels）的字体大小
set(get(gca, 'YAxis'), 'FontSize', 14);
%--------- savefig-------------
set(gca, 'Units', 'normalized');
set(gca, 'Position', [0.12, 0.12, 0.87, 0.86]);
