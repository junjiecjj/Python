...
p1 = plot(theta_grid, 10 * log10(P_des_plot + eps), 'LineStyle', '--', 'LineWidth', 2, 'Color', '#635e5e'); hold on;

p2 = plot(theta_grid, 10 * log10(P_mmse + eps), 'LineStyle', '--', 'LineWidth', 2, 'Color', '#F65314'); hold on;

p3 = plot(theta_grid, 10 * log10(P_mmse1 + eps), 'LineStyle', '-', 'LineWidth', 2, 'Color', '#8A2BE2'); hold on;

p4 = plot(theta_grid, 10 * log10(P_minmax + eps), 'LineStyle', '-', 'LineWidth', 2, 'Color', '#00A1F1');
...
h_legend = legend('Desired', 'SquaredErrOptim', 'AlterSquaredErrOptim', 'MaximumErrOptim', 'Interpreter','latex');  %图例，与上面的曲线先后对应
h_legend.Color = 'none';
legendsize = 12;
...
print(gcf, 'Fig_3_1.pdf', '-dpdf', '-vector');
