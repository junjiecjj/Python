...
plot(theta_grid, 10 * log10(P_des_plot + eps), 'LineStyle', '--', 'LineWidth', 2, 'Color', '#635e5e'); hold on;
plot(theta_grid, 10 * log10(P_mmse + eps), 'LineStyle', '--', 'LineWidth', 2, 'Color', '#F65314'); hold on;
plot(theta_grid, 10 * log10(P_mmse1 + eps), 'LineStyle', '-', 'LineWidth', 2, 'Color', '#8A2BE2'); hold on;
plot(theta_grid, 10 * log10(P_minmax + eps), 'LineStyle', '-', 'LineWidth', 2, 'Color', '#00A1F1');
