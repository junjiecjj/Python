...
p1 = plot(theta_plot, abs(P_des * alpha0), 'k-.', 'LineWidth', 2); hold on;
p1.Color = '#B0B0B0';

p2 = plot(theta_plot, P_opt0, 'b-', 'LineWidth', 2.5); hold on; hold on;
p2.Color = '#00A1F1';

p3 = plot(theta_plot, P_opt1, 'r--', 'LineWidth', 2.5); hold on;
p3.Color = '#F65314';
%-------------------------------------------------------------------
...
print(gcf, 'Fig_2_2.pdf', '-dpdf', '-vector');
