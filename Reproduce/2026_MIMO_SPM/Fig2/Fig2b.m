...
p1 = plot(theta_plot, abs(P_des * alpha0), 'k--', 'LineWidth', 1.5); hold on;
p1.Color = '#635e5e';

p2 = plot(theta_plot, P_opt0, 'b-', 'LineWidth', 1.5); hold on; hold on;
p2.Color = '#00A1F1';

p3 = plot(theta_plot, P_opt1, 'r--', 'LineWidth', 1.5); hold on;
p3.Color = '#F65314';
%-------------------------------------------------------------------
...
print(gcf, 'Fig_2_1.pdf', '-dpdf', '-vector');
