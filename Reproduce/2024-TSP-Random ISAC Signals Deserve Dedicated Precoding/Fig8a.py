...
# 第一组：(N_T,L)=(32,24)，使用实线
axs.plot(snr_db, result[32]['Water-Filling'], color=color_WF, linestyle='-', linewidth=2, marker='o', ms=7, markerfacecolor='white', label=r'Water-Filling, $N_t=32$', zorder=1)
# axs.plot(snr_db, result[32]['DIP (MB-SGP)'], color=color_DIP, linestyle='-', linewidth=2, label=r'DIP (MB-SGP), $N_t=32$', zorder=2)
axs.plot(snr_db, result[32]['DIP (SGP)'], color=color_DIP, linestyle='-', marker='d', ms=8, markerfacecolor='white',label=r'DIP (SGP), $N_t=32$', zorder=10)
axs.plot(snr_db, result[32]['DDP'], color=color_DDP, linestyle='-', linewidth=2, marker='s', ms=7, markerfacecolor='white', label=r'DDP, $N_t=32$', zorder=3)

# 第二组：(N_T,L)=(128,96)，使用虚线
axs.plot(snr_db, result[128]['Water-Filling'], color=color_WF, linestyle='--', linewidth=2, marker='o', ms=7, markerfacecolor='white', label=r'Water-Filling, $N_t=128$', zorder=1)
# axs.plot(snr_db, result[128]['DIP (MB-SGP)'], color=color_DIP, linestyle='--', linewidth=2, label=r'DIP (MB-SGP), $N_t=128$', zorder=2)
axs.plot(snr_db, result[128]['DIP (SGP)'], color=color_DIP, linestyle='--', marker='d', ms=8, markerfacecolor='white', label=r'DIP (SGP), $N_t=128$', zorder=10)
axs.plot(snr_db, result[128]['DDP'], color=color_DDP, linestyle='--', linewidth=2, marker='s', ms=7, markerfacecolor='white', label=r'DDP, $N_t=128$', zorder=3)
...
plt.savefig('Fig8a_TSP.pdf')
# plt.savefig('Fig8a_TSP.png', dpi=300, bbox_inches='tight')
