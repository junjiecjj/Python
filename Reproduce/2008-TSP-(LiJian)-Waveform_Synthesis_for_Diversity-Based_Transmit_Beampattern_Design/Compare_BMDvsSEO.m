...
plot(theta_plot, P_lit2, 'r-.', 'LineWidth', 1.5); hold on;
plot(theta_plot, P_lit2_, 'c-.', 'LineWidth', 1.5);
grid on;
xlabel('\theta (degrees)');
ylabel('Beampattern');
...
plot(theta_plot, 10 * log10(P_lit2 / max(P_lit2) + eps), 'r-.', 'LineWidth', 1.5); hold on;
plot(theta_plot, 10 * log10(P_lit2_ / max(P_lit2_) + eps), 'c-.', 'LineWidth', 1.5);
grid on;
xlabel('\theta (degrees)');
