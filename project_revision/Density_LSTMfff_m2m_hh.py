...
class DIS_PRED(object):
    ...
    def change_selfc_cal(self, name, thresh, time_dict, pred_result_dict):
        ...
        all_succ = [x for x in List if self.c[x,5]==1 or self.c[x,5]==2]
        chazhi = self.c[all_succ,2] - self.c[all_succ,3]
        aver_alarm = np.average(chazhi)
    ...
    def find_best_thresh(self,rtime,pred_result):
        ...
        pred_Rate = np.zeros((thresh_num,9))
