...
#=================================================================
#                   机器学习：套索回归
# https://www.wuzao.com/document/cvxpy/examples/machine_learning/lasso_regression.html
#=================================================================
...
def plot_train_test_errors(train_errors, test_errors, lambd_values):
    ...
    out_fig = plt.gcf()
    out_fig.savefig(filepath2+'Lasso_regression.eps', format='eps',  )
...
def plot_regularization_path(lambd_values, beta_values):
    ...
    filepath2 = '/home/jack/snap/'
    out_fig = plt.gcf()
    out_fig.savefig(filepath2+'Lasso_regressionRegularization.eps', format='eps',  )
    #out_fig .savefig(filepath2+'hh.png',format='png',dpi=1000, bbox_inches = 'tight')
    plt.show()
