...
class AE_cnn_classify_mnist_R_noiseless_join_Trainer():
    def __init__(self, classifier, args, loader, ckp, ):
        ...
        # print(f"0: classify.fc1.weight = \n  {self.classify.fc1.weight}\n classify.fc2.weight = \n  {self.classify.fc2.weight}")
        self.net          = None
        self.Loss         = None
    ...
    def train(self):
        ...
        for idx_c, comrate in enumerate(self.args.CompRate):
            ...
            if self.args.pretrain == True:
                predir = f"/home/{self.args.user_name}/SemanticNoise_AdversarialAttack/ModelSave/AE_Minst_R={comrate:.1f}_trainSnr=noiseless.pt"
            ...
            for epoch in range(self.args.epochs):
                ...
                self.optim.schedule()
                # epochLos = self.Loss.mean_log()[-1].item()
                epochLos = self.Loss.avg()  # len(self.loader_train.dataset)
            ...
            ### 保存网络中的参数, 速度快，占空间少
            torch.save(self.net.state_dict(), f"/home/{self.args.user_name}/SemanticNoise_AdversarialAttack/ModelSave/NoQuan_JoinLoss/AE_Minst_noQuant_joinLoss_R={comrate:.1f}_trainSnr={tsnr}.pt")
