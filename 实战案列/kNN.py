# -*- coding: utf-8 -*-
"""
Created on Fri Oct 27 22:24:18 2017
...
def handwritingclasstest():
    ...
    for i in range(m):
        ...
        trainmat[i,:]=img2vector(r'E:\统计学习\机器学习实战数据集\machinelearninginaction\Ch02\digits\trainingDigits/'+'%s' % trainingfilelist[i])
    ...
    for i in range(mtest):
        ...
        classnumstr=int(filenamestr.split('_')[0])      #这里的文件名只能用r''的格式，\testDigits/'+'%s' % testfilelist[i]，可以用加号+，也可以用空格
        vectorbetest=img2vector(r'E:\统计学习\机器学习实战数据集\machinelearninginaction\Ch02\digits\testDigits/'+'%s' % testfilelist[i])
