...
def visualize(x, y, z, axes, elev, azim, idx, fig, facecolors):
    ...
    ax.quiver(0, 0, 0,
              4, 0, 0,
              length = 1, color = 'r', normalize=False, arrow_length_ratio = .07, linestyles = 'solid', linewidths = 0.25, zorder = 1e5)

    ax.plot((0,0),(0,-4),(0,0), c = 'g', lw = 0.25, ls = '--')
    ax.quiver(0, 0, 0,
              0, 4, 0,
              length = 1, color = 'g', normalize=False, arrow_length_ratio = .07, linestyles = 'solid', linewidths = 0.25, zorder = 1e5)

    ax.plot((0,0),(0,0),(0,-4), c = 'b', lw = 0.25, ls = '--')
    ax.quiver(0, 0, 0,
              0, 0, 4,
              length = 1, color = 'b', normalize=False, arrow_length_ratio = .07, linestyles = 'solid', linewidths = 0.25, zorder = 1e5)
    ...
    ax.plot((axis_1[0], -axis_1[0]), (axis_1[1], -axis_1[1]), (axis_1[2], -axis_1[2]), c = 'k', lw = 0.25, ls = '--')
    ax.plot((axis_2[0], -axis_2[0]), (axis_2[1], -axis_2[1]), (axis_2[2], -axis_2[2]), c = 'k', lw = 0.25, ls = '--')
    ax.plot((axis_3[0], -axis_3[0]), (axis_3[1], -axis_3[1]), (axis_3[2], -axis_3[2]), c = 'k', lw = 0.25, ls = '--')
...
axes = np.array([[1.5, 0, 0],  # first axis
                 [0, 1.5, 0],  # second axis
                 [0, 0, 1.5]]) # third axis
colors = plt.cm.jet(np.linspace(0, 1, 101*101))
