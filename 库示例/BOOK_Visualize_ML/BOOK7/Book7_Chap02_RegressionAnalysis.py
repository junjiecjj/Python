...
alpha = 0.05
# 显著水平
t_95 = stats.t.ppf(1 - alpha/2, DFE) # DFE = 249
# t值

# 系数b1的1 – α 置信区间
b1_upper_95 = b1 + t_95*SE_b1
print(b1_upper_95) # 1.21765244
b1_lower_95 = b1 - t_95*SE_b1
print(b1_lower_95) # 1.02904866

# 系数b0的1 – α 置信区间
b0_upper_95 = b0 + t_95*SE_b0
print(b0_upper_95) # 0.0039431
b0_lower_95 = b0 - t_95*SE_b0
print(b0_lower_95) # -0.00015686
...
# 图 15. 一元线性回归线置信区间 (95%和 99%) 置信区间：因变量均值的区间
# confidence band
fig, ax = plt.subplots()
plt.scatter(x_df, y_df, alpha = 0.5)
...
sns.regplot(data=y_x_df, x = 'SP500', y = 'AAPL', ci=95)
plt.axis('scaled')

fig, ax = plt.subplots(figsize = (10, 10))
sns.regplot(data=y_x_df, x = 'SP500', y = 'AAPL', ci=99)
plt.axis('scaled')
...
fig, ax = plt.subplots()
plt.scatter(x_df,y_df, zorder = 10, color = 'b', alpha = 0.25);
plt.plot(x_i, y_i,color = 'r')
