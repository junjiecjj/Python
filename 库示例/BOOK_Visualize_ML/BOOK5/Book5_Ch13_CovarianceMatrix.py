...
g1 = sns.heatmap(X_df[y==0].cov(),cmap="rainbow", annot=None,cbar=False,ax=ax1,square=True, vmax = 0.4, vmin = 0)
ax1.set_title('Y = 0, setosa')

g2 = sns.heatmap(X_df[y==1].cov(),cmap="rainbow", annot=None,cbar=False,ax=ax2,square=True, vmax = 0.4, vmin = 0)
ax2.set_title('Y = 1, versicolor')

g3 = sns.heatmap(X_df[y==2].cov(),cmap="rainbow", annot=None,cbar=False,ax=ax3,square=True, vmax = 0.4, vmin = 0)
...
plt.sca(axs[4])
ax = sns.heatmap(LAMBDA,cmap='rainbow', cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('$\Lambda$')
...
plt.sca(axs[2])
ax = sns.heatmap(V_P,cmap='rainbow', cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('$V_Z$')
...
plt.sca(axs[4])
ax = sns.heatmap(LAMBDA_P,cmap='rainbow', cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('$\Lambda_Z$')
...
plt.sca(axs[6])
ax = sns.heatmap(V_P.T,cmap='rainbow', cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('$V_Z^T$')
...
plt.sca(axs[0])
ax = sns.heatmap(Y_c_df,cmap='rainbow', yticklabels=False, cbar_kws={"orientation": "horizontal"})
plt.title('$Y_c$')
...
plt.sca(axs[0])
ax = sns.heatmap(LAMBDA,cmap='rainbow', yticklabels=False, cbar_kws={"orientation": "horizontal"}, annot=True, fmt='.2f')
plt.title('$/Lambda$')
ax.set_aspect("equal")
...
plt.sca(axs[2])
ax = sns.heatmap(np.array([[1/(len(X_df) - 1)]]), cmap='rainbow', yticklabels=False, cbar_kws={"orientation": "horizontal"}, annot=True, fmt='.3f')
plt.title('$1/(n-1)$')
ax.set_aspect("equal")
...
plt.sca(axs[4])
ax = sns.heatmap(S,cmap='rainbow', yticklabels=False, cbar_kws={"orientation": "horizontal"}, annot=False, fmt='.2f')
plt.title('$S$')
ax.set_aspect("equal")
...
plt.sca(axs[0])
ax = sns.heatmap(np.matrix(d2),cmap='rainbow', linewidths=.05,annot=True, cbar_kws={"orientation": "horizontal"},fmt = '.2f')
ax.set_aspect("equal")
plt.title('$d^2$')
...
plt.sca(axs[2])
ax = sns.heatmap((x - MU).T,cmap='rainbow', linewidths=.05,annot=True, cbar_kws={"orientation": "horizontal"},fmt = '.2f')
ax.set_aspect("equal")
plt.title('(x - $\mu$)^T')
...
plt.sca(axs[4])
ax = sns.heatmap(SIGMA_inv,cmap='rainbow', linewidths=.05,annot=True, cbar_kws={"orientation": "horizontal"},fmt = '.2f')
ax.set_aspect("equal")
plt.title('$\Sigma^{-1}$')
...
plt.sca(axs[6])
ax = sns.heatmap((x - MU),cmap='rainbow', linewidths=.05,annot=True, cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('(x - $\mu$)')
...
plt.sca(axs[2])
ax = sns.heatmap(L,cmap='rainbow', cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('L')
...
plt.sca(axs[4])
ax = sns.heatmap(R,cmap='rainbow', cbar_kws={"orientation": "horizontal"})
ax.set_aspect("equal")
plt.title('R')
