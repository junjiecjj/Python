...
def MNIST_IID_6bit():
    ...
    axins = axs.inset_axes((0.6, 0.54, 0.3, 0.32))
    L = 300
    ...
    Y2 = data[:,1]
    axs.plot(data[:,0], Y2, color = colors[i], lw = 2, linestyle='--', label = r'$\mathrm{6bit}$'+',无错传输',)
    axins.plot(data[:,0], Y2, color = colors[i], linestyle = '--', linewidth = 2)
    i += 1

    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_6bits_sr_flip0.01_adam_0.01_U100+10_bs64_2026-01-04-09:59:25/Train.npy"))[:L]
    Y3 = data[:,1]
    axs.plot(data[:,0], Y3, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{6bit, BER=0.01}$',)
    axins.plot(data[:,0], Y3, color = colors[i], linestyle = '-', linewidth = 2)
    i += 1

    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_6bits_sr_flip0.1_adam_0.01_U100+10_bs64_2026-01-03-22:18:45/Train.npy"))[:L]
    Y4 = data[:,1]
    axs.plot(data[:,0], Y4, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{6bit, BER=0.1}$',)
    axins.plot(data[:,0], Y4, color = colors[i], linestyle = '-', linewidth = 2)
    i += 1

    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_6bits_sr_flip0.2_adam_0.01_U100+10_bs64_2026-01-03-22:34:13/Train.npy"))[:L]
    Y5 = data[:,1]
    axs.plot(data[:,0], Y5, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{6bit, BER=0.2}$',)
    axins.plot(data[:,0], Y5, color = colors[i], linestyle = '-', linewidth = 2)
    i += 1

    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_6bits_sr_flip0.3_adam_0.01_U100+10_bs64_2026-01-03-23:35:09/Train.npy"))[:L]
    Y6 = data[:,1]
    axs.plot(data[:,0], Y6, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{6bit, BER=0.3}$',)
    ...
    Y7 = data[:,1]
    axs.plot(data[:,0], Y7, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{6bit, BER=0.4}$',)
    ...
    legend1 = axs.legend(bbox_to_anchor = (0.52, 0.48), borderaxespad=0, edgecolor='black', prop=font2, borderpad = 0.1, labelspacing = 0.1)
    ...
    out_fig = plt.gcf()
    out_fig.savefig(f'{savedir}/Fig_MNIST_IID_6bit.pdf' )
    plt.show()
    plt.close()
    return
