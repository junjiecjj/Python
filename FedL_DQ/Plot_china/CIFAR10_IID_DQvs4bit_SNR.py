...
def CIFAR10_IID_DQvs4bit():
    ...
    axs.plot(data[:,0], Ydq3, color='#FF6347', lw = 2, linestyle=':', label = r'$\text{DQ+Free-Ride, SNR=0dB}$',)
    ...
    legend1 = axs.legend( bbox_to_anchor = (0.36, 0.06, 0.1, 0.1), loc='lower left', borderaxespad=0, edgecolor='black', prop=font2, borderpad = 0.1, labelspacing = 0.1)
