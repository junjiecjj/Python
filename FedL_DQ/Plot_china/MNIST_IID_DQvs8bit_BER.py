...
def MNIST_IID_DQvs8bit_BER():
    ...
    Y8_1 = data[:,1]
    axs.plot(data[:,0], Y8_1, color = '#1E90FF', lw = 2, linestyle='--', label = r'$\mathrm{8bit, BER=0.1}$',)
    ...
    Y8_2 = data[:,1]
    axs.plot(data[:,0], Y8_2, color = '#1E90FF', lw = 2, linestyle=(0,(3,1,1,1)), label = r'$\mathrm{8bit, BER=0.2}$',)
    ...
    Y8_3 = data[:,1]
    axs.plot(data[:,0], Y8_3, color = '#1E90FF', lw = 2, linestyle=':', marker = 'o', mfc='white', mew = 2, ms = 10, markevery=20, zorder = 1, label = r'$\mathrm{8bit, BER=0.3}$',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig(f'{savedir}/Fig_MNIST_IID_DQvs8bit_BER.pdf' )
    plt.show()
    plt.close()
    return

MNIST_IID_DQvs8bit_BER()
