...
def CIFAR10_IID_1bit():
    ...
    # data = np.load(os.path.join(rootdir, "CIFAR10_IID_epoch2_1bits_sr_flip0.1_adam_0.01_U100+10_bs64_2025-12-14-23:55:51/TraRecorder.npy"))[:L]
    # Ya = data[:,1]
    # axs.plot(data[:,0], Ya, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{1bit, BER=0.01}$',)
