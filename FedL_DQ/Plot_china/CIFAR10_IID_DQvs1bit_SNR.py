...
def CIFAR10_IID_DQvs1bit():
    ...
    axs.plot(data[:,0], Ydq2, color='#FF6347', lw = 2, linestyle=(0,(3,1,1,1)) , label = r'$\text{DQ+Free-Ride, SNR=0.75dB}$',)
    ...
    axs.plot(data[:,0], Ydq3, color='#FF6347', lw = 2, linestyle=':', marker = '*',ms = 10, markevery=50, zorder = 11, label = r'$\text{DQ+Free-Ride, SNR=0dB}$',)
