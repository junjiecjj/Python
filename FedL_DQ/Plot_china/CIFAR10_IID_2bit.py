...
def CIFAR10_IID_2bit():
    ...
    axins = axs.inset_axes((0.68, 0.55, 0.3, 0.32))
    L = 1000
    ...
    axs.plot(data1[:,0], Ya, color = colors[i], lw = 2, linestyle='-', label = r'$\text{2bit, BER=0.01}$',)
    ...
    axs.plot(data1[:,0], Y3, color = colors[i], lw = 2, linestyle='-', label = r'$\text{2bit, BER=0.05}$',)
    ...
    axs.plot(data1[:,0], Y4, color = colors[i], lw = 2, linestyle='-', label = r'$\text{2bit, BER=0.1}$',)
