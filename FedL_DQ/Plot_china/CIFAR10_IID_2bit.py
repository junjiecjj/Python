...
def CIFAR10_IID_2bit():
    ...
    axs.plot(data[:,0], Y2, color = colors[i], lw = 2, linestyle='--', label = r'$\mathrm{2bit}$'+',无错传输',)
    ...
    axs.plot(data1[:,0], Ya, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{2bit, BER=0.01}$',)
    ...
    axs.plot(data1[:,0], Y3, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{2bit, BER=0.05}$',)
    ...
    axs.plot(data1[:,0], Y4, color = colors[i], lw = 2, linestyle='-', label = r'$\mathrm{2bit, BER=0.1}$',)
