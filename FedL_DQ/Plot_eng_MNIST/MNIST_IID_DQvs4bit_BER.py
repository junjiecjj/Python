...
def MNIST_IID_DQvs4bit_BER():
    ...
    Ydq1 = data[:,1]
    axs.plot(data[:,0], Ydq1, color='#FF6347', lw = 2, linestyle='--' , label = "DQ, BER=0.1",)
    ...
    Ydq2 = data[:,1]
    axs.plot(data[:,0], Ydq2, color='#FF6347', lw = 2, linestyle=(0,(3,1,1,1)) , label = "DQ, BER=0.2")
    ...
    Ydq3 = data[:,1]
    axs.plot(data[:,0], Ydq3, color='#FF6347', lw = 2, linestyle=':', marker = '*',ms = 10, markevery=20, zorder = 11, label = "DQ, BER=0.3",)
    ...
    Y8_1 = data[:,1]
    axs.plot(data[:,0], Y8_1, color = '#1E90FF', lw = 2, linestyle='--', label = "4bit, BER=0.1",)
    ...
    Y8_2 = data[:,1]
    axs.plot(data[:,0], Y8_2, color = '#1E90FF', lw = 2, linestyle=(0,(3,1,1,1)), label = "4bit, BER=0.2")
    ...
    Y8_3 = data[:,1]
    axs.plot(data[:,0], Y8_3, color = '#1E90FF', lw = 2, linestyle=':', zorder = 1, label = "4bit, BER=0.3")
