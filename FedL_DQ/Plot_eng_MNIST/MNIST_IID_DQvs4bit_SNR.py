...
def MNIST_IID_DQvs4bit():
    ...
    Ydq3 = data[:,1]
    axs.plot(data[:,0], Ydq3, color='#FF6347', lw = 2, linestyle=':', label = "DQ+Free-Ride, SNR=-2dB")
    ...
    Y8_1 = data[:,1]
    axs.plot(data[:,0], Y8_1, color = '#1E90FF', lw = 2, linestyle='--', label = "4bit+LDPC, SNR=1dB")
    ...
    Y8_2 = data[:,1]
    axs.plot(data[:,0], Y8_2, color = '#1E90FF', lw = 2, linestyle=(0,(3,1,1,1)), label = "4bit+LDPC, SNR=0dB")
    ...
    Y8_3 = data[:,1]
    axs.plot(data[:,0], Y8_3, color = '#1E90FF', lw = 2, linestyle=':', label = "4bit+LDPC, SNR=-2dB")
