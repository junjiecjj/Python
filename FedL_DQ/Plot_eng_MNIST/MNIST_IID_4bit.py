...
def MNIST_IID_4bit():
    ...
    Y2 = data[:,1]
    axs.plot(data[:,0], Y2, color = colors[i], lw = 2, linestyle='--', label = '4bit, error-free',)
    ...
    Ya = data[:,1]
    axs.plot(data[:,0], Ya, color = colors[i], lw = 2, linestyle='-', label = '4bit, BER=0.01',)
    ...
    Y3 = data[:,1]
    axs.plot(data[:,0], Y3, color = colors[i], lw = 2, linestyle='-', label = '4bit, BER=0.1',)
    ...
    Y4 = data[:,1]
    axs.plot(data[:,0], Y4, color = colors[i], lw = 2, linestyle='-', label = '4bit, BER=0.2',)
    ...
    Y5 = data[:,1]
    axs.plot(data[:,0], Y5, color = colors[i], lw = 2, linestyle='-', label = '4bit, BER=0.3',)
