...
def CommOverHead():
    ...
    axs.plot(data[:,0], Y1, color = colors[i],  ls='-', lw = lw,  marker = mark[i], markersize = 10, markevery=50, label = 'DQ, error-free',)
    i += 1
    ...
    axs.plot(data[:,0], data[:, 0]*V*4, color = colors[i],  ls='-', lw = 2, marker = mark[i], markersize = 10, markevery=50, label = "4bit",)
    i += 1

    axs.plot(data[:,0], data[:, 0]*V*3, color = colors[i],  ls='-', lw = 2, marker = mark[i], markersize = 10, markevery=50, label = "3bit",)
    i += 1

    axs.plot(data[:,0], data[:, 0]*V*2, color = colors[i], ls='-', lw = 2, marker = mark[i], markersize = 10, mew = 4, markevery=50, label = "2bit",)
    i += 1

    axs.plot(data[:,0], data[:, 0]*V*1, color = colors[i], ls='-', lw = 2, marker = mark[i], markersize = 10, markevery=50, label = "1bit",)
    i += 1
