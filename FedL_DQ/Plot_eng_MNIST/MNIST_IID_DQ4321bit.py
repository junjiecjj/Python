...
def MNIST_IID_DQ4321bit():
    ...
    legend1 = axs.legend(bbox_to_anchor = (0.5, 0.45), borderaxespad=0, edgecolor='black', prop=font2, borderpad = 0.1, labelspacing = 0.1)
...
def DynamicBitWidth():
    ...
    Y1 = data[:,4]
    axs[3].plot(data[:,0], Y1, color = colors[i], lw = 2, linestyle='-', label = "DQ, BER=0.3",)
    i += 1
