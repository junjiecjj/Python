...
# -*- coding: utf-8 -*-
"""
Created on Sat Dec 13 16:34:32 2025
...
def MNIST_IID_DQvs4bit():
    ...
    Ydq1 = data[:,1]
    axs.plot(data[:,0], Ydq1, color='#FF6347', lw = 2, linestyle='--' , label = r'$\text{DQ+Free-Ride, SNR=1dB}$')
    ...
    Ydq2 = data[:,1]
    axs.plot(data[:,0], Ydq2, color='#FF6347', lw = 2, linestyle=(0,(3,1,1,1)) , label = r'$\text{DQ+Free-Ride, SNR=0dB}$')
    ...
    Ydq3 = data[:,1]
    axs.plot(data[:,0], Ydq3, color='#FF6347', lw = 2, linestyle=':', label = r'$\text{DQ+Free-Ride, SNR=-2dB}$')
    ...
    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_4bits_sr_flip0.0115_adam_0.01_U100+10_bs64_2026-01-25-14:07:35/Train.npy"))[:L]
    Y8_1 = data[:,1]
    axs.plot(data[:,0], Y8_1, color = '#1E90FF', lw = 2, linestyle='--', label = r'$\text{4bit+LDPC, SNR=1dB}$')
    axins.plot(data[:,0], Y8_1, color = '#1E90FF', linestyle = '--', linewidth = 2)
    i += 1

    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_4bits_sr_flip0.16_adam_0.01_U100+10_bs64_2026-01-25-14:07:50/Train.npy"))[:L]
    Y8_2 = data[:,1]
    axs.plot(data[:,0], Y8_2, color = '#1E90FF', lw = 2, linestyle=(0,(3,1,1,1)), label = r'$\text{4bit+LDPC, SNR=0dB}$')
    axins.plot(data[:,0], Y8_2, color = '#1E90FF', linestyle = (0,(3,1,1,1)), linewidth = 2)
    i += 1

    data = np.load(os.path.join(rootdir, "MNIST_IID_epoch1_4bits_sr_flip0.2513_adam_0.01_U100+10_bs64_2026-01-25-14:07:59/Train.npy"))[:L]
    Y8_3 = data[:,1]
    axs.plot(data[:,0], Y8_3, color = '#1E90FF', lw = 2, linestyle=':', label = r'$\text{4bit+LDPC, SNR=-2dB}$')
    ...
    out_fig = plt.gcf()
    out_fig.savefig(f'{savedir}/Fig_MNIST_IID_DQvs4bit_SNR.pdf' )
    plt.show()
    plt.close()
    return
