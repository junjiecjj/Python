...
def CIAFR10_IID_DQ4321bit():
    ...
    axs.plot(data[:,0], Yp , color = 'k', linestyle= '-',lw = 2, label = 'Perfect',)
    ...
    axs.plot(data[:,0], Y4, color = colors[i], lw = 2, linestyle='--', marker = '*', ms = 14, markevery=100, mfc='white', mew = 2, label = '4bit, error-free', zorder =10)
    ...
    axs.plot(data[:,0], Y3, color = colors[i], lw = 2, linestyle='--', marker = 'o', ms = 14, markevery=100, mfc='white', mew = 2, label = '3bit, error-free', zorder =1)
    ...
    axs.plot(data[:,0], Y2, color = colors[i], lw = 2, linestyle='--', marker = 'd', ms = 12, markevery=100, mfc='white', mew = 2, label = '2bit, error-free', zorder =1)
...
def DynamicBitWidth():
    ...
    Y1 = data[:,4]
    axs[1].plot(data[:,0], Y1, color = colors[i], lw = 2, linestyle='-', label = "DQ, BER=0.01")
    i += 1
    ...
    Y1 = data[:,4]
    axs[2].plot(data[:,0], Y1, color = colors[i], lw = 2, linestyle='-', label = "DQ, BER=0.05")
    i += 1
...
def CommOverHead():
    ...
    axs.plot(data1[:,0], Y1, color = colors[i],  ls='-', lw = lw,  marker = mark[i], markersize = 10, markevery=100, label = "DQ, BER=0.01")
    i += 1

    data = np.load(os.path.join(rootdir, "CIFAR10_IID_epoch2_DQ_sr_flip0.05_adam_0.01_U100+10_bs64_2025-12-18-21:17:06/TraRecorder.npy"))[:L]
    Y1 = np.cumsum(data[:,4]*V)
    axs.plot(data[:,0], Y1, color = colors[i],  ls='-', lw = lw,  marker = mark[i], markersize = 10, markevery=100, label = "DQ, BER=0.05")
    i += 1

    data = np.load(os.path.join(rootdir, "CIFAR10_IID_epoch2_1bits_sr_erf_adam_0.01_U100+10_bs64_2025-12-15-14:28:54/TraRecorder.npy"))[:L]
    Y1 = np.cumsum(data[:,4]*V)
    axs.plot(data[:,0], Y1, color = colors[i],  ls='-', lw = lw,  marker = mark[i], markersize = 10, markevery=100, label = "DQ, BER=0.1")
    i += 1

    axs.plot(data[:,0], data[:, 0]*V*8, color = colors[i],  ls='-', lw = 2, marker = mark[i], markersize = 10, markevery=100, label = "4bit")
    i += 1

    axs.plot(data[:,0], data[:, 0]*V*4, color = colors[i], ls='-', lw = 2, marker = mark[i], markersize = 10, markevery=100, label = "3bit")
    i += 1
