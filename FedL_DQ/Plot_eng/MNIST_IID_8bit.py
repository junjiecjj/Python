...
def MNIST_IID_8bit():
    ...
    Y2 = data[:,1]
    axs.plot(data[:,0], Y2, color = colors[i], lw = 2, linestyle='--', label = '8bit, error-free',)
    ...
    Y3 = data[:,1]
    axs.plot(data[:,0], Y3, color = colors[i], lw = 2, linestyle='-', label = "8bit, BER=0.01",)
    ...
    Y4 = data[:,1]
    axs.plot(data[:,0], Y4, color = colors[i], lw = 2, linestyle='-', label = "8bit, BER=0.1",)
    ...
    Y5 = data[:,1]
    axs.plot(data[:,0], Y5, color = colors[i], lw = 2, linestyle='-', label = "8bit, BER=0.2",)
    ...
    Y6 = data[:,1]
    axs.plot(data[:,0], Y6, color = colors[i], lw = 2, linestyle='-', label = "8bit, BER=0.3",)
    ...
    Y7 = data[:,1]
    axs.plot(data[:,0], Y7, color = colors[i], lw = 2, linestyle='-', label = "8bit, BER=0.4",)
    ...
    out_fig = plt.gcf()
    out_fig.savefig(f'{savedir}/Fig_MNIST_IID_8bit.pdf' )
    plt.show()
    plt.close()
    return
