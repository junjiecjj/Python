...
def CIFAR10_IID_DQvs4bit():
    ...
    axs.plot(data[:,0], Y4_1, color = '#1E90FF', lw = 2, linestyle='--', label = "4bit, BER=0.01")
    ...
    axs.plot(data[:,0], Y4_2, color = '#1E90FF', lw = 2, linestyle=(0,(3,1,1,1)), label = "4bit, BER=0.05")
    ...
    axs.plot(data1[:,0], Y4_3, color = '#1E90FF', lw = 2, linestyle=':', label = "4bit, BER=0.1")
