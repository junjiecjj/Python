...
def CIFAR10_IID_DQvs1bit():
    ...
    axs.plot(data[:,0], Ydq1, color='#FF6347', lw = 2, linestyle='--' , label = "DQ, BER=0.01")
    ...
    axs.plot(data[:,0], Ydq2, color='#FF6347', lw = 2, linestyle=(0,(3,1,1,1)) , label = "DQ, BER=0.05")
    ...
    axs.plot(data[:,0], Ydq3, color='#FF6347', lw = 2, linestyle=':', marker = '*',ms = 10, markevery=50, zorder = 11, label = "DQ, BER=0.1")
    ...
    axs.plot(data[:,0], Y4_1, color = '#1E90FF', lw = 2, linestyle='--', label = "1bit, BER=0.01")
    ...
    axs.plot(data[:,0], Y4_2, color = '#1E90FF', lw = 2, linestyle=(0,(3,1,1,1)), label = "1bit, BER=0.05")
    ...
    axs.plot(data[:,0], Y4_3, color = '#1E90FF', lw = 2, ls=':', marker = 'o', mfc='white', mew = 2, ms = 10, markevery=50, zorder = 1, label = "1bit, BER=0.1")
