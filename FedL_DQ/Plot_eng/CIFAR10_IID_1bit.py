...
def CIFAR10_IID_1bit():
    ...
    axins = axs.inset_axes((0.62, 0.48, 0.3, 0.32))
    L = 1000
    ...
    axs.plot(data[:,0], Y2, color = colors[i], lw = 2, linestyle='-', label = '1bit, error-free',)
    ...
    Ya = data[:,1]
    axs.plot(data[:,0], Ya, color = colors[i], lw = 2, linestyle='-', label = "1bit, BER=0.05")
    ...
    axs.plot(data1[:,0], Y3, color = colors[i], lw = 2, linestyle='-', label = "1bit, BER=0.1")
    ...
    axs.plot(data[:,0], Y4, color = colors[i], lw = 2, linestyle='-', label = "1bit, BER=0.2",)
    ...
    axs.plot(data[:,0], Y5, color = colors[i], lw = 2, linestyle='-', label = "1bit, BER=0.3")
