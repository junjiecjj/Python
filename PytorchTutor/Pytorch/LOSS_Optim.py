...
# = 0.7715 + log( exp( − 0.7715 ) + exp( − 0.6205 ) + exp( − 0.2562 ) = 1.3447266007601868 =0.7715+log(exp(-0.7715)+exp(-0.6205)+exp(-0.2562)=1.3447266007601868
...
"""
输入值:
tensor([0.5327, 0.6038, 0.5364], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([0., 0., 0.])
计算loss的结果:
tensor([0.7608, 0.9259, 0.7688], grad_fn=<BinaryCrossEntropyBackward0>)
"""
...
"""
输入值:
tensor([0.4292, 0.7824, 0.8186], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([1., 0., 1.])
计算loss的结果:
tensor([0.8459, 1.5251, 0.2002], grad_fn=<BinaryCrossEntropyBackward0>)
"""
...
"""
输入值:
tensor([0.4529, 0.6393, 0.7831], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([0., 1., 1.])
计算loss的结果:
...
"""
输入值:
tensor([0.4599, 0.3843, 0.2965], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([0., 0., 1.])
计算loss的结果:
tensor(2.3168, grad_fn=<BinaryCrossEntropyBackward0>)
"""
...
"""
输入值:
tensor([0.1567, 0.7602, 0.7188], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([0., 1., 0.])
计算loss的结果:
tensor([0.1704, 0.2742, 1.2687], grad_fn=<BinaryCrossEntropyBackward0>)
"""
...
"""
输入值:
tensor([0.4597, 0.9034, 0.7058], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([1., 0., 0.])
计算loss的结果:
tensor(4.3381, grad_fn=<BinaryCrossEntropyBackward0>)
"""
...
"""
输入值:
tensor([0.7246, 0.6558, 0.2506], grad_fn=<SigmoidBackward0>)
输出的目标值:
tensor([0., 0., 0.])
计算loss的结果:
tensor(0.8816, grad_fn=<BinaryCrossEntropyBackward0>)
"""
