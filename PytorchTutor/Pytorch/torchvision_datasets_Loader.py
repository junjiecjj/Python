...
这里需要说明一下，root是你的根目录，ants和bees是root文件夹下的两个子文件夹，xxx.png、xxy.jpeg、xxz.png是ants文件夹下的图片，123.jpg、nsdf3.png、asd932_.png是bees文件夹下的图片，也就是说ants和bees是分类标签，利用这些你可以按如下的方式创建一个数据加载器 (dataloader) ,在这里我们以Imagenet数据集为例：
