...
"""
此函数的功能是从平顶端开始训练，同时也从平顶端开始验证，从平顶端测试；LSTM的many-to-one
用的是13种诊断
"""
#########################################################################
...
class DIS_PRED(object):
    ...
    def get_dictdata(self, name, Arr):
        ...
        for i, j in enumerate(lisT):
            ...
            if self.b[i,1] == -1:
                ...
                y = 1/(1+np.exp(-(tmp[self.time_step:,-1]-(self.b[j,3]-0.5))*25))
    ...
    def fit_and_predict(self, train_data, all_data):
        ...
        X_train, Y_train, _ = self.get_dictdata('train', train_data)
