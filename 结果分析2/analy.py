...
font = FontProperties(fname="/usr/share/fonts/truetype/msttcorefonts/Times_New_Roman.ttf", size = 14)#fname =  "/usr/share/fonts/truetype/arphic/SimSun.ttf",
font1 = FontProperties(fname="/usr/share/fonts/truetype/msttcorefonts/Times_New_Roman.ttf", size = 16)
...
class ViewData(object):
    ...
    def see(self,i):
        ...
        if self.a[i,2]==1:
            plt.suptitle('density limit disruptive pulse:%d'%self.a[i,0],fontproperties = font1)
        else:
            plt.suptitle('nondisruptive pulse:%d'%self.a[i,0],fontproperties = font1)
