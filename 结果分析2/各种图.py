...
axs[0].plot(t,s1,color='b',linestyle='-',label='sin(x)',)
...
axs[0].set_title('sin and tan',fontproperties = font)
...
axs[1].set_title(r'$t_{disr}$=%d'%1,loc='left',fontproperties = font)
axs[1].grid()
...
axs[2].set_xlabel(r'time (s)',fontproperties = font)
