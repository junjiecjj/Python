...
def MNIST_IID_1bit_jointVsTDMA():
    ...
    axs.plot(data[:,0]*TperRound, Y1, color = 'k', linestyle= '-',lw = 1.3, marker = 'o', ms = 18, mfc = 'white',mew = 2, markevery = 50, label = 'Perfect',)
    ...
    Y3 = data[:,col]
    axs.plot(data[:,0]*TperRound, Y3, color = '#0D95CE' , lw = 2, linestyle='--', marker = '*', ms = 14, mfc = 'white',mew = 2, markevery = 50, label = '1-bit, proposed',)
