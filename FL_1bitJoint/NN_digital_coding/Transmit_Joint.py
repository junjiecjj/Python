...
def OneBit_proposed(message_lst, args, P, pl_Au, ldpc, modem, H = None, noisevar = 1, key_grad = None, G = 2**8):
    key_lst_wo_grad = []
    info_lst = []
    ...
    uu_hat = transmission_proposed(args, copy.deepcopy(uu), P, pl_Au, ldpc, modem, H = H, noisevar = noisevar)
...
def transmission_proposed(args, uu, P, pl_Au, ldpc, modem, H = None, noisevar = 1):
    K = uu.shape[0]
    D = uu.shape[-1]
