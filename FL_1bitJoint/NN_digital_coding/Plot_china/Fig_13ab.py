...
def CIFAR10_IID_1bit_coding():
    ...
    axs.plot(data[:,0], Y1, color = 'k', linestyle= '-',lw = 1.3, marker = 'o', ms = 18, mfc = 'white',mew = 2, markevery = 100, label = '完美传输',)
    ...
    axs.plot(data[:,0], Y3, color = '#0D95CE' , lw = 2, linestyle='--', marker = '*', ms = 14, mfc = 'white',mew = 2, markevery = 100, label = r'$\mathrm{1bit},$'+'联合译码',)
    ...
    out_fig = plt.gcf()
    if col == 1:
        out_fig.savefig('../Fig_china/Fig13_a.pdf' )
    elif col == 2:
        out_fig.savefig('../Fig_china/CIFAR10_IID_1bit_coding_loss.pdf' )
    plt.show()
...
def CIFAR10_nonIID_1bit_coding():
    ...
    out_fig = plt.gcf()
    if col == 1:
        out_fig.savefig('../Fig_china/Fig13_b.pdf' )
    elif col == 2:
        out_fig.savefig('../Fig_china/CIFAR10_nonIID_1bit_coding_loss.eps' )
    plt.show()
