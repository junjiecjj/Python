...
def MNIST_IID_1bit_coding():
    ...
    Y1 = data[:,col]
    axs.plot(data[:,0], Y1, color = 'k', linestyle= '-',lw = 1.3, marker = 'o', ms = 18, mfc = 'white',mew = 2, markevery = 50, label = '完美传输',)
    ...
    Y2 = data[:,col]
    axs.plot(data[:,0], Y2, color = '#FE2701', lw = 2, linestyle='--',  label = r'$\mathrm{1bit},$'+'无错传输',)
    ...
    Y3 = data[:,col]
    axs.plot(data[:,0], Y3, color = '#0D95CE' , lw = 2, linestyle='--', marker = '*', ms = 14, mfc = 'white',mew = 2, markevery = 50, label =  r'$\mathrm{1bit},$'+'联合译码', )
    ...
    Y4 = data[:,col]
    axs.plot(data[:,0],Y4, color = '#FBCB1F' , lw = 2, linestyle='--', label = r'$\mathrm{1bit, SIC}$',)
    ...
    out_fig = plt.gcf()
    if col == 1:
        out_fig.savefig('../Fig_china/Fig12_a.pdf' )

    elif col == 2:

        out_fig.savefig('../Fig_china/MNIST_IID_1bit_coding_loss.pdf' )
    plt.show()
...
def MNIST_IID_4bit_coding():
    ...
    Y2 = data[:,col]
    axs.plot(data[:,0], Y2, color = '#FE2701', lw = 2, linestyle='--',  label = r'$\mathrm{4bit},$'+'无错传输', )
    # axins.plot(data[:,0], Y2, color = '#FE2701', linestyle = '--', linewidth = 2)
    ...
    Y3 = data[:,col]
    axs.plot(data[:,0], Y3, color = '#0D95CE' , lw = 2, linestyle='--', marker = '*', ms = 14, mfc = 'white',mew = 2, markevery = 50, label = r'$\mathrm{4bit},$'+'联合译码', )
    # axins.plot(data[:,0], Y3, color = '#0D95CE', linestyle = '--', linewidth = 2)
    ...
    Y4 = data[:,col]
    axs.plot(data[:,0],Y4, color = '#FBCB1F' , lw = 2, linestyle='--', label = r'$\mathrm{4bit, SIC}$',)
    # axins.plot(data[:,0], Y4, color = '#FBCB1F', linestyle = '--', linewidth = 2)
    ...
    out_fig = plt.gcf()
    if col == 1:
        out_fig.savefig('../Fig_china/Fig12_b.pdf' )

    elif col == 2:

        out_fig.savefig('../Fig_china/MNIST_IID_4bit_coding_loss.pdf' )
    plt.show()
...
def MNIST_nonIID_1bit_coding():
    ...
    out_fig = plt.gcf()
    if col == 1:
        out_fig.savefig('../Fig_china/Fig12_c.pdf' )
    elif col == 2:
        out_fig.savefig('../Fig_china/MNIST_nonIID_1bit_coding_loss.pdf' )
    plt.show()
...
def MNIST_nonIID_4bit_coding():
    ...
    out_fig = plt.gcf()
    if col == 1:
        out_fig.savefig('../Fig_china/Fig12_d.pdf' )
    elif col == 2:
        out_fig.savefig('../Fig_china/MNIST_nonIID_4bit_coding_loss.pdf' )
    plt.show()
