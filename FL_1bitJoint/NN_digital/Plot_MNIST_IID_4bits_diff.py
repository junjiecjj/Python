...
def LocalBatchIID():
    ...
    ## 4-bit erf
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_4bits_sr_erf_sgd_0.01_U100+6_bs128_2024-12-24-10:50:59/TraRecorder.npy")[:L]
    Y2 = data[:, 1]
    axs.plot(data[:,0], data[:,1], color = '#E918B5', lw = 3, linestyle='--', label = '4-bit Error-free',)

    ## 4-bit, 0.0001ber
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_4bits_sr_flip0.0001_sgd_0.01_U100+6_bs128_2024-12-24-10:52:34/TraRecorder.npy")[:L]
    data[49,1] = 0.8961
    Y3 = data[:, 1]
    axs.plot(data[:,0], data[:,1], color = 'b' , lw = 3, linestyle='--', label = '4-bit, BER=$10^{-4}$',)

    # ## 4-bit 0.001ber
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_4bits_sr_flip0.001_sgd_0.01_U100+6_bs128_2024-12-24-10:52:14/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    axs.plot(data[:,0], data[:,1], color = 'g', lw = 3, linestyle='--', label = '4-bit, BER=$10^{-3}$',)

    # ## 4-bit 0.01ber
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_4bits_sr_flip0.01_sgd_0.01_U100+6_bs128_2024-12-24-10:51:38/TraRecorder.npy")[:L]
    Y4 = data[:, 1]
    axs.plot(data[:,0], data[:,1], color = '#CD853F', lw = 3, linestyle='--',  label = '4-bit, BER=$10^{-2}$',)

    # ## 4-bit 0.1ber
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_4bits_sr_flip0.1_sgd_0.01_U100+6_bs128_2024-12-24-10:51:27/TraRecorder.npy")[:L]
    Y5 = data[:, 1]
...
def LocalBatchIID_loss():
    ...
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_sgd_0.01_U100+6_bs128_2024-12-16-15:26:49/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], data[:,2], color = 'k', linestyle= '-', marker = 'o', ms = 18, mfc = 'white',mew = 2, markevery = 100, label = 'Error-free',)
    ...
    Y3 = data[:, 1]
    axs.plot(data[:,0], data[:,2], color = 'b' , lw = 3, linestyle='--', label = '4-bit, BER=$10^{-4}$',)

    # ## 4-bit 0.001ber
    data = np.load("/home/jack/FL_1bitJoint/NN/MNIST_IID_diff_batchs3_4bits_sr_flip0.001_sgd_0.01_U100+6_bs128_2024-12-24-10:52:14/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    axs.plot(data[:,0], data[:,2], color = 'g', lw = 3, linestyle='--', label = '4-bit, BER=$10^{-3}$',)
