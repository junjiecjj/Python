...
def Large_small_acc():
    ...
    axs.plot(data[:,0], savgol_filter(data[:,1], 5, 3, mode= 'nearest'), color = 'olive', lw = 3, linestyle='--', label = '1-bit w/o LDPC, -60dBm',)
    ...
    axs.plot(data[:,0], savgol_filter(data[:,1], 5, 3, mode= 'nearest'), color = 'r', lw = 3, linestyle='-',  label = '1-bit w/o LDPC, -55dBm',)
    ...
    axs.plot(data[:,0], savgol_filter(data[:,1], 5, 3, mode= 'nearest'), color = 'r', lw = 3, linestyle='none', marker = 'o', ms = 12, markevery = 50, label = 'Proposed 1-bit w/ LDPC, -55dBm',)
