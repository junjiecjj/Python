...
def CIFAR10_IID_14bit_erf_acc():
    ...
    axs.plot(data[:,0], Y1 , color = 'k', linestyle= '-',lw = 1.2, marker = 'o', ms = 14, mfc = 'white',mew = 2, markevery = 100,  label = '完美传输',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig6_c.pdf' )
...
def Cifar10_IID_1bit_flip_acc():
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_resnet20_IID/CIFAR10_IID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-14-14:15:05/TraRecorder.npy")[:L]
    Y1 = savgol_filter(data[:,1], 10, 3)
    axs.plot(data[:,0], Y1, color = 'k', lw = 1.3, linestyle='-', marker = 'o', ms = 18, mfc = 'white', markevery = 100, label = '完美传输',)
    axins.plot(data[:,0], Y1, color = 'k', linestyle = '-', linewidth = 2)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig9_a.pdf' )
...
def Cifar10_IID_1bit_flip_loss():
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_resnet20_IID/CIFAR10_IID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-14-14:15:05/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], data[:,2], color = 'k', lw = 1.2, linestyle='-', marker = 'o', ms = 18, mfc = 'white', markevery = 100, label = '完美传输',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig9_b.pdf' )
...
def Cifar10_BatchIID_K0_1bit_flip_acc():
    ...
    # axs.set_xlim(-0.2, 2)  #拉开坐标轴范围显示投影
    # axs.set_ylim(0.2, 0.92)  #拉开坐标轴范围显示投影
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig11_c.pdf' )
