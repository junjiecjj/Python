...
def Cifar10_IID_4bit_flip_acc():
    ...
    axs.plot(data[:,0], Y1, color = 'k', lw = 1.2, linestyle='-', marker = 'o', ms = 18, mfc = 'white', markevery = 100, label = '完美传输',)
    ...
    axs.plot(data[:,0], Y2, color = '#E918B5', lw = 2, linestyle='--', marker = '*', ms = 18,  markevery = 100, label = r'$\mathrm{4bit},$'+'无错传输',)
    ...
    axs.plot(data[:,0], Y5, color = '#CD853F', lw = 2, linestyle='--',  label = r'$\mathrm{4bit, BER=0.1}$',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig9_c.pdf' )
...
def Cifar10_IID_4bit_flip_loss():
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_resnet20_IID/CIFAR10_IID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-14-14:15:05/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,2], 10, 3), color = 'k', lw = 1.2, linestyle='-', marker = 'o', ms = 18, mfc = 'white', markevery = 100, label = '完美传输',)

    ## 1-bit erf
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_resnet20_IID/CIFAR10_IID_diff_epoch2_4bits_sr_erf_sgd_0.01_U100+6_bs64_2025-01-14-15:40:27/TraRecorder.npy")[:L]
    Y2 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,2], 10, 3), color = '#E918B5', lw = 2, linestyle='--', marker = '*', ms = 18,  markevery = 100, label = r'$\mathrm{4bit},$'+'无错传输',)
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_resnet20_IID/CIFAR10_IID_diff_epoch2_4bits_sr_flip0.1_sgd_0.01_U100+6_bs64_2025-01-15-13:32:27/TraRecorder.npy")[:L]
    Y5 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,2], 10, 3), color = '#CD853F', lw = 2, linestyle='--',  label = r'$\mathrm{4bit, BER=0.1}$',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig9_d.pdf' )
