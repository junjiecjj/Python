...
def Cifar10_IID_4bit_flip_acc():
    ...
    axs.plot(data[:,0], Y2, color = '#E918B5', lw = 2, linestyle='--', marker = '*', ms = 18,  markevery = 100, label = '4-bit, 无错传输',)
...
def Cifar10_IID_4bit_flip_loss():
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_resnet20_IID/CIFAR10_IID_diff_epoch2_4bits_sr_erf_sgd_0.01_U100+6_bs64_2025-01-14-15:40:27/TraRecorder.npy")[:L]
    Y2 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,2], 10, 3), color = '#E918B5', lw = 2, linestyle='--', marker = '*', ms = 18,  markevery = 100, label = '4-bit, 无错传输',)
