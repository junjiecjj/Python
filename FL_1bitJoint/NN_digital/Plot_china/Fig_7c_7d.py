...
def MNIST_BatchIID_4bit_flip_acc():
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig7_c.pdf' )
...
def MNIST_BatchIID_4bit_flip_loss():
    ...
    ## erf
    data = np.load("/home/jack/FL_1bitJoint/MNIST_CNN_IID/MNIST_IID_diff_batchs3_sgd_0.01_U100+6_bs128_2025-01-16-13:29:21/TraRecorder.npy")[:L]
    axs.plot(data[:,0], data[:,2], color = 'k', linestyle= '-', marker = 'o', ms = 15, mfc = 'white',mew = 2, markevery = 100, label = '完美传输',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Fig_china/Fig7_d.pdf' )
