...
def MNIST_BatchnonIID_flip_acc():
    ...
    L = 1000
    ## erf
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-12-21:37:10/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    ...
    ## 1-bit erf
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_1bits_sr_erf_sgd_0.01_U100+6_bs64_2025-01-12-21:41:22/TraRecorder.npy")[:L]
    Y2 = data[:, 1]
    ...
    ## 1-bit, 0.1ber
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_1bits_sr_flip0.1_sgd_0.01_U100+6_bs64_2025-01-13-09:35:36/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    ...
    # ## 1-bit 0.2ber
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_1bits_sr_flip0.2_sgd_0.01_U100+6_bs64_2025-01-13-09:40:01/TraRecorder.npy")[:L]
    Y4 = data[:, 1]
    ...
    # ## 1-bit 0.3ber
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_1bits_sr_flip0.3_sgd_0.01_U100+6_bs64_2025-01-13-09:40:08/TraRecorder.npy")[:L]
    Y5 = data[:, 1]
    ...
    ## 1-bit 0.4ber
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_1bits_sr_flip0.4_sgd_0.01_U100+6_bs64_2025-01-13-09:40:20/TraRecorder.npy")[:L]
    Y6 = data[:, 1]
    ...
    ## 1-bit 0.5ber
    data1 = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_1bits_sr_flip0.5_sgd_0.01_U100+6_bs64_2025-01-13-09:45:52/TraRecorder.npy")
    # Y7 = data[:, 1]
    axs.plot(data1[:,0], savgol_filter(data1[:,1], 10, 3), color = '#778899', lw = 2, linestyle='--',  label = '1-bit, BER=0.5',)
    ...
    ##==================== mother and son ==================================
    ### 局部显示并且进行连线,方法3
    zone_and_linked(axs, axins, 875, 885, data[:, 0] , [Y1, Y2, Y3, Y4, Y5, Y6], 'bottom', x_ratio = 0.3, y_ratio = 0.2)
    ## linewidth
    bw = 1
...
def MNIST_BatchnonIID_flip_loss():
    ...
    L = 1000
    ## erf
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-12-21:37:10/TraRecorder.npy")[9:L]
...
def MNIST_BatchnonIID_14bit_erf_acc():
    ...
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-12-21:37:10/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'k', linestyle= '-',lw = 1.3, marker = 'o', ms = 14, mfc = 'white',mew = 2, markevery = 50,  label = 'Perfect',)
    axins.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'k', linestyle = '-', linewidth = 2)
    ...
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_4bits_sr_erf_sgd_0.01_U100+6_bs64_2025-01-12-21:44:33/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'b' , lw = 2, linestyle='--', label = '4-bit, Error-free',)
    axins.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'b', linestyle = '--', linewidth = 2)
    ...
    ##==================== mother and son ==================================
    ### 局部显示并且进行连线,方法3
    zone_and_linked(axs, axins, 270, 275, data[:, 0] , [Y1, Y2, Y3, ], 'bottom', x_ratio = 0.3, y_ratio = 0.2)
    ## linewidth
    bw = 1
    axins.spines['bottom'].set_linewidth(bw) ###设置底部坐标轴的粗细
    axins.spines['left'].set_linewidth(bw)   ###设置左边坐标轴的粗细
