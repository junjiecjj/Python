...
def Cifar10_nonIID_1bit_flip_acc():
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Figures/Fig10_a.eps' )
    # out_fig.savefig('../Figures/Cifar10_nonIID_1bit_bitflip_acc.pdf' )
    plt.show()
    return
...
def Cifar10_nonIID_1bit_flip_loss():
    ...
    Y1 = lw_envelope
    axs.plot(data[:,0], lw_envelope , color = 'k', linestyle= '-', lw = 1.2,  label = 'Perfect',) # marker = 'o', ms = 14, mfc = 'white',mew = 2, markevery = 100,
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Figures/Fig10_b.eps' )
    # out_fig.savefig('../Figures/Cifar10_nonIID_1bit_bitflip_loss.pdf' )
    plt.show()
    return
...
def CIFAR10_nonIID_14bit_erf_acc():
    ...
    up_envelope, lw_envelope = envelope_extraction(up_envelope)
    Y1 = up_envelope
    axs.plot(data[:,0], up_envelope , color = 'k', linestyle= '-',lw = 1.2,   label = 'Perfect',)
    # axins.plot(data[:,0], up_envelope, color = 'k', linestyle = '-', linewidth = 2)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Figures/Fig6_d.eps' )
    # out_fig.savefig('../Figures/Cifar10_nonIID_14bit_erf_acc.pdf' )
    plt.show()
...
def Cifar10_nonIID_K0_1bit_flip_acc():
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Figures/Fig11_d.eps' )
    # out_fig.savefig('../Figures/Cifar10_nonIID_1bit_flip_K0_acc.pdf' )
    plt.show()
