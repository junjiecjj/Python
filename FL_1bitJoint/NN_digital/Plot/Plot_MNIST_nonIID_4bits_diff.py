...
def MNIST_epoch_nonIID_4bit_flip_acc():
    ...
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_4bits_sr_flip0.001_sgd_0.01_U100+6_bs64_2025-01-13-10:50:23/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    ...
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_4bits_sr_flip0.01_sgd_0.01_U100+6_bs64_2025-01-13-10:50:13/TraRecorder.npy")[:L]
    Y4 = data[:, 1]
    ...
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_4bits_sr_flip0.1_sgd_0.01_U100+6_bs64_2025-01-13-10:46:28/TraRecorder.npy")[:L]
    Y5 = data[:, 1]
    ...
    ##==================== mother and son ==================================
    ### 局部显示并且进行连线,方法3
    zone_and_linked(axs, axins, 820, 850, data[:, 0] , [Y1, Y2, Y3, Y4, ], 'bottom', x_ratio = 0.3, y_ratio = 0.2)
    ## linewidth
    bw = 1
...
def MNIST_epoch_nonIID_4bit_flip_loss():
    ...
    ## erf
    data = np.load("/home/jack/FL_1bitJoint/MNIST_nonIID/MNIST_noIID_diff_epoch2_sgd_0.01_U100+6_bs64_2025-01-12-21:37:10/TraRecorder.npy")[:L]
    axs.plot(data[:,0], savgol_filter(data[:,2], 10, 3), color = 'k', linestyle= '-', marker = 'o', ms = 15, mfc = 'white',mew = 2, markevery = 100, label = 'Perfect',)
