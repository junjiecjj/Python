...
def CIFAR10_BatchIID_4bit_flip_acc():
    ...
    Y1 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'k', linestyle= '-', marker = 'o', ms = 18, mfc = 'white',mew = 2, markevery = 100, label = 'Perfect',)
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_flip0.001_sgd_0.01_U100+6_bs32_2025-01-11-16:57:19/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_flip0.01_sgd_0.01_U100+6_bs32_2025-01-11-16:22:38/TraRecorder.npy")[:L]
    Y4 = data[:, 1]
    ...
    # ##==================== mother and son ==================================
    ### 局部显示并且进行连线,方法3
    zone_and_linked(axs, axins, 860, 880, data[:, 0] , [Y1, Y2, Y3, Y4 ], 'bottom', x_ratio = 0.1, y_ratio = 0.2)
    ## linewidth
    bw = 1
...
def CIFAR10_BatchIID_4bit_flip_loss():
    ...
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_sgd_0.01_U100+6_bs32_2025-01-09-22:08:00/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,2], 10, 3), color = 'k', linestyle= '-', marker = 'o', ms = 18, mfc = 'white',mew = 2, markevery = 100, label = 'Perfect',)
    # axins.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'k', linestyle = '-', linewidth = 2)
...
def Cifar10_BatchIID_K0_4bit_acc():
    # %% 画图
    fig, axs = plt.subplots(1, 1, figsize=(8, 6), constrained_layout=True)
    axins = axs.inset_axes((0.62, 0.4, 0.3, 0.32))
    L = 1000
    ## erf
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_erf_sgd_0.01_U100+2_bs32_2025-01-11-20:17:13/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'k', linestyle= '-',lw = 2,   label = r'4-bit, Error-free, K$_0$=2',)
    axins.plot(data[:,0], data[:,1], color = 'k', linestyle = '-', linewidth = 2)

    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_erf_sgd_0.01_U100+6_bs32_2025-01-10-14:18:49/TraRecorder.npy")[:L]
    Y2 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = '#E918B5', lw = 3, linestyle='-', label = r'4-bit, Error-free, K$_0$=6',)
    axins.plot(data[:,0], data[:,1], color = '#E918B5', linestyle = '--', linewidth = 2)

    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_erf_sgd_0.01_U100+12_bs32_2025-01-11-20:17:32/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'b' , lw = 3, linestyle='-', label = r'4-bit, Error-free, K$_0$=12',)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Figures/Cifar10_IID_4bit_erf_K0_acc.eps' )
    out_fig.savefig('../Figures/Cifar10_IID_4bit_erf_K0_acc.pdf' )
    plt.show()

def Cifar10_BatchIID_K0_4bit_flip_acc():
    # %% 画图
    fig, axs = plt.subplots(1, 1, figsize=(8, 6), constrained_layout=True)
    axins = axs.inset_axes((0.62, 0.33, 0.3, 0.32))
    L = 1000
    ## erf
    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_flip0.01_sgd_0.01_U100+2_bs32_2025-01-11-20:39:04/TraRecorder.npy")[:L]
    Y1 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'k', linestyle= '-',lw = 2,   label = r'4-bit, BER=0.01, K$_0$=2',)
    axins.plot(data[:,0], data[:,1], color = 'k', linestyle = '-', linewidth = 2)

    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_flip0.01_sgd_0.01_U100+6_bs32_2025-01-11-16:22:38/TraRecorder.npy")[:L]
    Y2 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = '#E918B5', lw = 3, linestyle='-', label = r'4-bit, BER=0.01, K$_0$=6',)
    axins.plot(data[:,0], data[:,1], color = '#E918B5', linestyle = '--', linewidth = 2)

    data = np.load("/home/jack/FL_1bitJoint/CIFAR10_IID/CIFAR10_IID_diff_batchs10_4bits_sr_flip0.01_sgd_0.01_U100+12_bs32_2025-01-11-20:39:37/TraRecorder.npy")[:L]
    Y3 = data[:, 1]
    axs.plot(data[:,0], savgol_filter(data[:,1], 10, 3), color = 'b' , lw = 3, linestyle='-', label = r'4-bit, BER=0.01, K$_0$=12',)
    axins.plot(data[:,0], data[:,1], color = 'b', linestyle = '--', linewidth = 2)
    ...
    out_fig = plt.gcf()
    out_fig.savefig('../Figures/Cifar10_IID_4bit_flip_K0_acc.eps' )
    out_fig.savefig('../Figures/Cifar10_IID_4bit_flip_K0_acc.pdf' )
    plt.show()
...
Cifar10_BatchIID_K0_4bit_acc()
Cifar10_BatchIID_K0_4bit_flip_acc()
