...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 24 21:29:18 2024
...
def LocalBatchIID():
    ...
    axs.plot(data[:,0], data[:,1], color = 'c', linestyle= '-', label = 'Error-free, K$_0$=6',)
    ...
    # axs.plot(data[:,0], data[:,1], color = '#00BFFF', lw = 2, linestyle='--', label = 'Error-free, 8-bit, K$_0$=6',)
    ...
    # axs.plot(data[:,0], data[:,1], color = 'g' , lw = 2, linestyle='--', label = '8-bit, BER=$10^{-5}$, K$_0$=6',)
    ...
    # axs.plot(data[:,0], data[:,1], color = 'r' , lw = 2, linestyle='--', label = '8-bit, BER=$10^{-4}$, K$_0$=6',)
    ...
    # axs.plot(data[:,0], data[:,1], color = 'b', lw = 2, linestyle='--', label = '8-bit, BER=$10^{-3}$, K$_0$=6',)

    # #### k0=20
    data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_sgd_0.01_U100+20_bs32_2024-12-24-17:48:12/TraRecorder.npy")[:L]
    axs.plot(data[:,0], data[:,1], color = 'k' , lw = 2, linestyle='-', label = 'Error-free, K$_0$=20',)

    # data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_8bits_sr_erf_sgd_0.01_U100+20_bs32_2024-12-24-22:00:24/TraRecorder.npy")[:L]
    # axs.plot(data[:,0], data[:,1], color = 'g' , lw = 2, linestyle='--', label = '8-bit, K$_0$=20',)

    # data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_8bits_sr_flip0.0001_sgd_0.01_U100+20_bs32_2024-12-25-09:42:11/TraRecorder.npy")[:L]
    # axs.plot(data[:,0], data[:,1], color = 'r' , lw = 2, linestyle='-', label = '8-bit, K$_0$=20, BER=$10^{-4}$, K$_0$=20',)

    # data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_8bits_sr_flip0.001_sgd_0.01_U100+20_bs32_2024-12-25-09:41:55/TraRecorder.npy")[:L]
    # axs.plot(data[:,0], data[:,1], color = 'b' , lw = 2, linestyle='--', label = '8-bit, K$_0$=20, BER=$10^{-3}$, K$_0$=20',)

    # ## k0=10
    data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_sgd_0.01_U100+10_bs32_2024-12-24-21:19:40/TraRecorder.npy")[:L]
    axs.plot(data[:,0], data[:,1], color = '#7B68EE' , lw = 2, linestyle='-', label = 'Error-free, K$_0$=10',)

    # data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_8bits_sr_erf_sgd_0.01_U100+10_bs32_2024-12-24-21:40:00/TraRecorder.npy")[:L]
    # axs.plot(data[:,0], data[:,1], color = 'g' , lw = 2, linestyle='--', label = '8-bit, K$_0$=10',)

    # data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_8bits_sr_flip0.0001_sgd_0.01_U100+10_bs32_2024-12-25-09:42:38/TraRecorder.npy")[:L]
    # axs.plot(data[:,0], data[:,1], color = 'r' , lw = 2, linestyle='--', label = '8-bit, K$_0$=10, BER=$10^{-4}$',)

    # data = np.load("/home/jack/FL_1bitJoint/NN/CIFAR10_IID_diff_batchs15_8bits_sr_flip0.001_sgd_0.01_U100+10_bs32_2024-12-24-21:51:46/TraRecorder.npy")[:L]
    # axs.plot(data[:,0], data[:,1], color = 'b' , lw = 2, linestyle='--', label = '8-bit, K$_0$=10, BER=$10^{-3}$',)
    ...
    out_fig = plt.gcf()
    # out_fig.savefig('./Figures/Cifar10_IID_4bit_localBatch_acc.eps' )
    # out_fig.savefig('./Figures/Cifar10_IID_4bit_localBatch_acc.pdf' )
    plt.show()
