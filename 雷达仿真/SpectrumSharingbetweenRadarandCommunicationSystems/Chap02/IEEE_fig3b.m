...
for z = 1:length(P_FA)
    ...
    for b = 1:BS
        ...
        % plot(SNR_db',Pd_NSP_cat_mean(b,:,z),'b','LineWidth',2.5); hold on;
        % plot(SNR_db',Pd_NSP_cat_mean(b,:,z),'r','LineWidth',2.5); hold on;
        % plot(SNR_db',Pd_NSP_cat_mean(b,:,z),'m','LineWidth',2.5); hold on;
        % plot(SNR_db',Pd_NSP_cat_mean(b,:,z),'y','LineWidth',2.5); hold on;
    end
