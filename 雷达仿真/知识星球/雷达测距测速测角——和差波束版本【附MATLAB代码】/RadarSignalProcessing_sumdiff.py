...
def generate_beams(lamda, d_LinearArray):
    """生成波束和鉴角曲线"""
    ...
    return w_1, w_2, AB_ybili, theta, theta_min, theta_max
...
def initialize_targets():
    ...
    # 场景参数
    x_positions = np.arange(-4e3, 4e3 + V * T, V * T)
    nT = len(x_positions)
...
Xk, Zk, Detect_Result = run_simulation()
