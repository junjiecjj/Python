...
xlabel('time [sec]')
ylabel('magnitude [v]')
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\雷达发射信号.jpg')   % 保存为png格式的图片。
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\雷达回波信号.jpg')   % 保存为png格式的图片。
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%      和差波束调制    %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('time [sec]')
ylabel('magnitude [v]')
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\和差调制回波信号.jpg')   % 保存为png格式的图片。
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\匹配滤波结果.jpg')   % 保存为png格式的图片。
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\MTD结果.jpg')   % 保存为png格式的图片。
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\CFAR结果.jpg')   % 保存为png格式的图片。
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\距离与多普勒定心.jpg')   % 保存为png格式的图片。
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\解模糊结果.jpg')   % 保存为png格式的图片
...
xlabel('time [sec]')
ylabel('角度 [°]')
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\测角结果.jpg')   % 保存为png格式的图片。
figure
...
print(gcf,'-dbitmap','G:\202404\20240428\PD_radar\我的代码\仿真图片\重频测角取平均.jpg')   % 保存为png格式的图片
