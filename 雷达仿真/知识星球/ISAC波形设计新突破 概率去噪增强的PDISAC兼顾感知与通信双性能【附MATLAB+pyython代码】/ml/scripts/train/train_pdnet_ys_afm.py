    ...
    for epoch in range(epochs):
        ...
        for batch_images in tqdm(train_loader):
            ...
            Z_PRBS_waveform_pred, RD_pred, kls = model(
                Y=Y_PRBS_waveform, S=PRBS_waveform, Z=Z_PRBS_waveform_no_noise
            )
            ...
            Z_hat_PRBS_waveform_pred, _, _ = model(
                Y=Y_hat_PRBS_waveform, S=PRBS_waveform, Z=Z_PRBS_waveform_no_noise
            )
        ...
        with torch.no_grad():
            for batch_idx, batch_images in enumerate(test_loader):
                ...
                Z_hat_PRBS_waveform_pred = model.predict(
            ...
            plot_matrix(
                {
                    ...
                    "Z_PRBS_waveform_pred": Z_hat_PRBS_waveform_pred[0],
