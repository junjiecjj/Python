...
def AFmean_lfm_OFDM_single(N_c, T_b, mu, x, y, weight):
    ...
    surf = ax.plot_surface(X, Y, AF_u, cmap='viridis', edgecolor='none')
...
surf1 = ax1.plot_surface(X, Y, AF_ofdm, cmap='viridis', edgecolor='none')
...
surf2 = ax2.plot_surface(X, Y, AF_ocdm, cmap='viridis', edgecolor='none')
