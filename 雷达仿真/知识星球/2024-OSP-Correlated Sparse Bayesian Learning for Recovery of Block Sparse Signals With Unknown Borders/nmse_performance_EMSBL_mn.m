...
%%
NMSE_set_corr_new = NMSE_set_corr;
NMSE_set_corr_new(NMSE_set_corr_new>0.4)=0;
%clean outliers
for i = 1:6
     idx{i}=find(NMSE_set_corr_new(i,:)==0);
     aa(i) = size(idx{i},2);
end
multiplier = 1+aa/iter;
...
plot(data,(mean(NMSE_set_ebsbl4,2)),'LineWidth',ll)
hold on
plot(data,(mean(NMSE_set_corr_new.*[multiplier'],2)),'--*','LineWidth',ll)
