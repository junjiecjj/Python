...
nmse1=norm(mean(abs(x_new(i1)),2)-mean(abs(X(i1)),2))^2/org_x1
nmse2=norm(mean(abs(x_new(i2)),2)-mean(abs(X(i2)),2))^2/org_x2
nmse3=norm(mean(abs(x_new(i3)),2)-mean(abs(X(i3)),2))^2/org_x3
