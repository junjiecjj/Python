...
from pipeline import Quant_BPSK_AWGN_Pipe
...
def main():
    ...
    for round_idx in range(args.num_comm):
        ...
        for client in  candidates:
            ...
            ## 量化、编码、信道、解码、反量化;
            local_parameters, ber, fer, avg_iter = Quant_BPSK_AWGN_Pipe(local_parameters, snr = 2.0 , quantBits = 6, com_round = round_idx, client = client)
            local_parameters = local_parameters.to(args.device)
