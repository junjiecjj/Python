...
## 每个客户端是否一样多的数据
parser.add_argument('--isBalance',       type=int,   default = 1,              help = 'numer of the clients')
## 训练次数(客户端更新次数)
...
## 模型名称
parser.add_argument('--model_name',      type=str,   default = "mnist_2nn",    help = 'the model to train')
## 所用的数据集
parser.add_argument("--dataset",         type=str,   default = "mnist",        help = "需要训练的数据集")
## 数据较多的客户端的数据量
parser.add_argument('--more',            type=int,   default = 1000,           help = 'numer of the clients')
## 数据较多的客户端的训练次数
parser.add_argument('--moreEpoch',       type=int,   default = 10,             help = 'numer of the clients')
## 客户端的数量
...
parser.add_argument('--num_comm',        type=int,   default = 1000,           help = 'number of communications')
## 传输的是模型参数还是模型更新
