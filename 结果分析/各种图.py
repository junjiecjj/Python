...
A,=axs[0].plot(t,s1,color='b',linestyle='-',linewidth=2,marker='*',markerfacecolor='red',markersize=12)
B,=axs[0].plot(t,s3,color='b',linestyle='-',linewidth=2,marker='o',markerfacecolor='c',markersize=12)
C=axs[0].axvline(x=1,ls='--',color='b')
axs[0].legend((A,B,C),('sin(x)','tan(x)','disruption time'),loc='best',shadow=True)
...
D,=axs[1].plot(t,s2,color='r',linestyle='--',linewidth=2,label=r'$cos(x)$',markerfacecolor='k',markersize=12)
...
axs[1].legend((D,E,F),('cos(x)','disruption','hh'),loc='best',shadow=True)
