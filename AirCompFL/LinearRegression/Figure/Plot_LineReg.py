...
def erf_E135_U10():
    ...
    axs.semilogy(dt[:,0], dt[:,1], linestyle='', marker = 'o', ms = 15, mfc='none', mew = 2, mec = 'k', markevery = 100, label = "grad, E = 1, User = 10",  zorder = 1)

    ## erf, diff, E = 1, num_of_user = 10
    dt = np.load(now10 + "/user10_bs100_diff_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = '*', ms = 13, c = '#1E90FF',  markevery = 100, label = "diff, E = 1, User = 10",  zorder = 2 )

    ## erf, diff, E = 3, num_of_user = 10
    dt = np.load(now10 + "/user10_bs100_diff_E3_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = '>', ms = 13, c = '#1E90FF',  markevery = 100, label = "diff, E = 3, User = 10", zorder = 2 )

    ## erf, diff, E = 5, num_of_user = 10
    dt = np.load(now10 + "/user10_bs100_diff_E5_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = 's', ms = 10, c = '#1E90FF',  markevery = 100, label = "diff, E = 3, User = 10", zorder = 2)

    ## erf, model, E = 1, num_of_user = 10
    dt = np.load(now10 + "/user10_bs100_model_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(5,5)), lw = 2,  c = '#FF0000',  label = "model, E = 1, User = 10", zorder = 3  )

    ## erf, model, E = 3, num_of_user = 10
    dt = np.load(now10 + "/user10_bs100_model_E3_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(5,10)), lw = 3,  c = '#FF0000', label = "model, E = 3, User = 10", zorder = 3  )

    ## erf, model, E = 5, num_of_user = 10
    dt = np.load(now10 + "/user10_bs100_model_E5_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(1,1)), lw = 2,  c = '#FF0000',  label = "model, E = 3, User = 10", zorder = 3 )
...
def erf_E1_User103060():
    ...
    axs.semilogy(dt[:,0], dt[:,1], linestyle='', marker = 'd', ms = 15, mfc='none', mew = 2, mec = 'k', markevery = 100, label = "grad, E = 1, User = 30",  zorder = 1)

    ## erf, grad, E = 1, num_of_user = 60
    dt = np.load(now60 + "/user60_bs100_gradient_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='', marker = 's', ms = 15, mfc='none', mew = 2, mec = 'k', markevery = 100, label = "grad, E = 1, User = 60",  zorder = 1)
    ...
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = '>', ms = 13, c = '#1E90FF',  markevery = 100, label = "diff, E = 1, User = 30", zorder = 2 )

    ## erf, diff, E = 1, num_of_user = 60
    dt = np.load(now60 + "/user60_bs100_diff_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = 's', ms = 10, c = '#1E90FF',  markevery = 100, label = "diff, E = 1, User = 60", zorder = 2)
    ...
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(5,10)), lw = 3,  c = '#FF0000', label = "model, E = 1, User = 30", zorder = 3  )

    ## erf, model, E = 1, num_of_user = 60
    dt = np.load(now60 + "/user60_bs100_model_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(1,1)), lw = 2,  c = '#FF0000',  label = "model, E = 1, User = 60", zorder = 3 )
...
def rician_E1_SNR():
    ...
    ## erf, diff, E = 3, num_of_user = 30
    dt = np.load(now30 + "/user30_bs100_diff_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = '>', ms = 13, c = '#1E90FF',  markevery = 100, label = "diff, E = 1, User = 30", zorder = 2 )

    ## erf, diff, E = 5, num_of_user = 60
    dt = np.load(now60 + "/user60_bs100_diff_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle='-', lw = lw, marker = 's', ms = 10, c = '#1E90FF',  markevery = 100, label = "diff, E = 1, User = 60", zorder = 2)
    ...
    ## erf, model, E = 3, num_of_user = 30
    dt = np.load(now30 + "/user30_bs100_model_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(5,10)), lw = 3,  c = '#FF0000', label = "model, E = 1, User = 30", zorder = 3  )

    ## erf, model, E = 5, num_of_user = 60
    dt = np.load(now60 + "/user60_bs100_model_E1_erf_fixedLr/TraRecorder.npy")
    axs.semilogy(dt[:,0], dt[:,1], linestyle=(0,(1,1)), lw = 2,  c = '#FF0000',  label = "model, E = 1, User = 60", zorder = 3 )
    ...
    savedir =  '/home/jack/AirFL/LineR_figures/'
    os.makedirs(savedir, exist_ok = True)
    out_fig.savefig(savedir + 'rician_.eps', bbox_inches='tight', pad_inches=0,)
    return
