...
def args_parser():
    ...
    parser.add_argument('--local_ds', type=int, default=500, help="local data size")   ## 本地数据大小
...
#     def cc(self, ):
#         self.args.lr_decrease = True

# s = Server(args)
# # args.lr_decrease = True

# s.cc()

# print(f"2: {args.lr_decrease}")
# print(f"3: {s.args.lr_decrease}")
