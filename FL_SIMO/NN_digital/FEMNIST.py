...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  5 21:08:55 2024
...
class FEMNIST(MNIST):
    ...
    def download(self):
        ...
        os.makedirs(self.raw_folder, exist_ok = 1)
        os.makedirs(self.processed_folder, exist_ok = 1)
...
femnist = FEMNIST(root = "/home/jack/DigitalFL/Dataset/femnist", )
